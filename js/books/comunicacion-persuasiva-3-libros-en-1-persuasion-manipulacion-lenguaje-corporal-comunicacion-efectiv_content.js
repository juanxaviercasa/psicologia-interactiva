const BOOK_CONTENT = { modules: [
  {
    ...
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "--- COMUNICACIÓN PERSUASIVA 3 libros en 1 Comunicación efectiva para controlar instantáneamente cualquier conversación. Primer libro: Claves efectivas para la persuasión. Segundo libro: Claves efectivas para la manipulación mental. Tercer libro: Lenguaje corporal revelado. Hayden J. Power --- Copyright ©2020 - Hayden J. Power Todos los derechos reservados --- Prólogo Este libro es una combinación de tres obras principales de Hayden J. Power: Claves efectivas para la persuasión, Claves efectivas para la manipulación mental, Lenguaje corporal revelado. Será un viaje completo para comprender plenamente todos los mecanismos que entran en juego cuando dos personas hablan entre sí, para entender cómo la mente percibe los mensajes y cómo ser convincente y dominar cualquier conversación. En el primer libro el autor se ocupa de la persuasión, que es el arte de cambiar la actitud o el comportamiento de los demás mediante un intercambio de ideas. Todos los principios serán analizados para que luego podamos entender cómo pueden funcionar las diversas técnicas. En el segundo libro, por otro lado, se analiza la Manipulación Mental, donde prevalece el uso de esquemas y métodos furtivos y engañosos que también pueden conducir al abuso tanto psicológico como físico. El tercer libro analiza el lenguaje corporal, que representa el 55% de nuestra comunicación. Saberlo es importante tanto para poder comprender instantáneamente los pensamientos de los demás como para poder controlar los propios ge",
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": "uasión, la manipulación utiliza diferentes técnicas y tiene diferentes propósitos. La manipulación utiliza esquemas, técnicas y métodos muy precisos, engañosos y tacaños, con el riesgo de conducir a situaciones de abuso tanto psicológico como físico. ---",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 4",
        "realExample": "consejos apresuradamente a menos que esté seguro de que la persona con la que está hablando ya está preparada para aceptarlos. Intervenga en el momento adecuado (por ejemplo, durante los descansos) y de la manera correcta. Atención y concentración “Nuestro cerebro está hecho de modo que cuanto más un evento despierta emociones, más atención se le presta.” (Piero Angela) Eso sí, tarde o temprano llega un momento en el que tenemos que ser el centro de atención. Hemos tenido mucho tiempo para estudiar a nuestros interlocutores, hemos ganado confianza y finalmente están dispuestos a escucharnos. No es fácil captar la atención del público y saber mantenerla en el tiempo. La atención es la capacidad de seleccionar los elementos y la información que, dentro de un contexto determinado, se consideran importantes. Hablamos de concentración cuando nos referimos a la atención sostenida, es decir, la atención que perdura en el tiempo. Para intervenir positivamente en la concentración, es necesario elevar el nivel de motivación. Además, debemos darnos cuenta de que no todas las personas son perceptivas y, por lo tanto, pueden captar inmediatamente información importante dentro de un contexto. Algunas personas responden con menos rapidez y necesitan más estimulación, otras tienen déficit de atención e hiperactividad. Por tanto, es necesario utilizar todas las armas a disposición para mantener constante el nivel de atención del público. Seguramente los primeros minutos son fundamentales y pu",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": "\" en las tiendas? El principio de escasez es uno de los más poderosos y utilizados en marketing. Pero, ¿por qué tiene tanto éxito? Hay dos razones muy concretas. Podemos empezar diciendo que la gente ama la exclusividad. Si un artículo tiene disponibilidad limitada, significa que no todo el mundo puede tenerlo y que a la gente le encanta tener artículos que otras personas no pueden tener. La primera razón por lo tanto está muy relacionada con la emocionalidad de una persona que, por ejemplo, imagina que puede lucir su nueva compra incluso antes de haberla comprado, por supuesto será envidiado por todos aquellos que no pudieron conseguirlo a tiempo. La segunda razón está relacionada con el valor del producto. Un producto raro es un producto de mayor valor. Esto no es una verdad absoluta pero es exactamente el mensaje que nos llega a la mente cada vez que nos encontramos ante un producto en disponibilidad limitada. Por tanto, la percepción que tenemos del valor de un producto también varía según su disponibilidad. El comercio electrónico siempre muestra la disponibilidad de un producto y muy a menudo nos encontramos con las palabras \"solo queda...\". Incluso en las tiendas físicas, los dependientes suelen acudir a la computadora para informarnos sobre la disponibilidad de un producto. Que la escasez afecta el valor también es evidente para aquellas personas que suelen intentar pedir un descuento sobre el precio. Cuando tienen el último artículo disponible frente a ellos, estas p",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 20",
        "realExample": "son razonablemente válidas y hacer una elección se vuelve más difícil.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 7",
        "realExample": "íctima toda su autoridad. La agresión física ocurre cuando se avanza el estado de manipulación.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 6",
        "realExample": "que se dé cuenta de que ha sido manipulado, no debe correr el riesgo de intentar razonar con el manipulador. Es una situación que se da muy a menudo porque, en el inconsciente de la víctima, se ha establecido un sentimiento de amor hacia su torturador y por tanto siempre existe un miedo al abandono que lleva a tomar decisiones equivocadas. Hay que renunciar a cualquier enfrentamiento abierto y huir de las discusiones porque estas terminarían favoreciendo al manipulador.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 9",
        "realExample": "as palabras y así emprender un camino correcto de regreso a la vida normal.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m16",
    "bookNumber": 16,
    "title": "Libro 3 Lenguaje Corporal Revelado",
    "keyPillars": [
      {
        "title": "Parte 1",
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 8",
        "realExample": "tas acercarte a una pareja que está hablando y tienden a alejarse, la señal indica que la conversación está abierta. En estos casos, es fácil llegar a una posición circular en la que varias personas participan en la misma discusión. ---",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
