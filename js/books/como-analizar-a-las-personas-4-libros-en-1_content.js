const BOOK_CONTENT = { modules: [
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": ", Recurso a la autoridad, Urgencia. Ticket, Percepción de precio más bajo, Precio de lujo, Ticket alto, Descuento, El número 7, Un cumplido sincero, Imágenes, La verdad, Flexibilidad de comportamiento, Las emociones, Energía, Apelar a la razón, Preguntas retóricas, Anticipando objeciones, Atreverse a una predicción, Narración corporativa, Brecha de curiosidad, Cambiar el enfoque, Somos lo mismo, Unicidad, Especificidad, La elección teórica, Los 7 trucos psicológicos más simples y comunes, La técnica del \"incluso si...\", Repetición, Efecto de mancha, Analogía, El primer paso, Precio exorbitante, Efecto de calor, Conclusión. CLAVES EFECTIVAS PARA LA MANIPULACIÓN MENTAL: Introducción, Definición, Manipulación y manipulación mental consciente, Psicología oscura, El manipulador perfecto, Psicópatas: depredadores y parásitos, Las víctimas, Propósito de la manipulación mental, Manipulación pasiva y activa, PNL y manipulación mental, Visual, auditivo y cinestésico, La mente subconsciente, Programación neurolingüística, Técnicas de PNL, Técnicas iniciales de manipulación mental, Calibración. Simetría, Recalcular, Fomento de la confianza, Otras técnicas de manipulación mental, Bombardeo de amor, El silencio, Doble vínculo, Luz de gas, Técnicas conductuales, Obligaciones financieras, Asociación de estímulos - respuesta emocional positiva, Otras técnicas con un estado de manipulación continuo, Manipulación: cómo reconocerla, Manipulación: cómo defenderse, Escucharte a ti mismo, Recuerda",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "aprender, Brazos y piernas cruzados, Sonreír, El efecto espejo, Postura, Contacto visual, Cejas, Asentir, La mandíbula, Palmas de las manos, ¿Cuál es el punto de poder leer el lenguaje corporal?, La consistencia: conocimientos, Expresiones faciales, Ojos, La mirada, Los párpados, Las pupilas, La boca y los labios, Brazos y piernas, Tobillos cruzados, Postura, Proxemía, Movimientos que indican liberación tensional, Actitudes comunes, Gestos de derechos territoriales, Gestos que indican nerviosismo y/o estados de ansiedad. Gestos de interrupción, Gestos de aburrimiento, Gestos de expectativa, Curiosidad por los gestos más obvios y habituales, Conclusión.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": "ón, la manipulación utiliza diferentes técnicas y tiene diferentes propósitos. La manipulación utiliza esquemas, técnicas y métodos muy precisos, engañosos y tacaños, con el riesgo de conducir a situaciones de abuso tanto psicológico como físico.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 5",
        "realExample": ". La duración de los tres primeros pasos es variable y depende de la situación, del tiempo disponible y de nuestro proyecto. En una situación como la que acabamos de describir es normal que todo se concentre en una o como máximo dos frases. Para quienes en cambio regalan un libro electrónico a cambio de una suscripción, los pasos son más largos porque, sobre todo cuando no usamos un medio original (hoy todo el mundo regala su libro electrónico), es necesario adquirir autoridad a los ojos del potencial cliente. Solo el cuarto paso es siempre corto porque cuando llega el momento de llevar al interlocutor a la acción hay que hacerlo de forma directa. Auto-persuasión Aquellos que quieran aprender las técnicas y los principios de la persuasión no pueden ignorar la idea de que también existe la auto-persuasión. La auto-persuasión es un fenómeno que ocurre como resultado de eventos externos combinados con un mensaje repetitivo o como resultado de un intento erróneo de persuasión. Ambos casos son muy frecuentes. Podemos señalar que con la llegada de las redes sociales se ha definido una nueva categoría de personas: los haters. Entre ellos no es difícil identificar a quienes han sufrido el fenómeno de la auto-persuasión. Piense en las publicaciones patrocinadas en Facebook, donde hay personas que anuncian nuevos trabajos en línea y que prometen grandes ganancias. Al leer los mensajes, podemos identificar fácilmente a todos aquellos que se han persuadido a sí mismos de que todos estos",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "situación es mucho más fácil actuar correctamente si admite que puede estar equivocado. Nunca debe dar por sentado que tiene razón, nunca mostrar claramente que está seguro de que su idea es la correcta. Transmitir el mensaje de que está dispuesto a cambiar de opinión en presencia de nuevas condiciones o pruebas lo hace sentir más cómodo para enfrentar y abrirse a nuevos puntos de vista. Solo con un interlocutor preparado es posible interactuar de la manera correcta, aplicando las técnicas y principios que veremos a continuación.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 4",
        "realExample": "frezca consejos apresuradamente a menos que esté seguro de que la persona con la que está hablando ya está preparada para aceptarlos. Intervenga en el momento adecuado (por ejemplo, durante los descansos) y de la manera correcta. Atención y concentración “Nuestro cerebro está hecho de modo que cuanto más un evento despierta emociones, más atención se le presta.” (Piero Angela) Eso sí, tarde o temprano llega un momento en el que tenemos que ser el centro de atención. Hemos tenido mucho tiempo para estudiar a nuestros interlocutores, hemos ganado confianza y finalmente están dispuestos a escucharnos. No es fácil captar la atención del público y saber mantenerla en el tiempo. La atención es la capacidad de seleccionar los elementos y la información que, dentro de un contexto determinado, se consideran importantes. Hablamos de concentración cuando nos referimos a la atención sostenida, es decir, la atención que perdura en el tiempo. Para intervenir positivamente en la concentración, es necesario elevar el nivel de motivación. Además, debemos darnos cuenta de que no todas las personas son perceptivas y, por lo tanto, pueden captar inmediatamente información importante dentro de un contexto. Algunas personas responden con menos rapidez y necesitan más estimulación, otras tienen déficit de atención e hiperactividad. Por tanto, es necesario utilizar todas las armas a disposición para mantener constante el nivel de atención del público. Seguramente los primeros minutos son fundamental",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "utilizando un estilo de comunicación abierto ofrece ciertamente muchas ventajas, tanto porque no presupone reglas rígidas como porque permite que quienes ejecutan el discurso sean más flexibles. Además, utilizar un estilo de comunicación abierto también tranquiliza al interlocutor, quien se animará a apoyar nuestro punto de vista. Durante la discusión es bueno prestar atención a las palabras que se utilizan. Por eso los grandes oradores no hacen discursos improvisados, sino que sus interpretaciones son el resultado del estudio, el ensayo y la práctica. Dependiendo del tipo de discurso que tengamos que pronunciar, es posible sustituir una palabra menos eficaz por otra más eficaz, o eliminar un término que pueda evocar una situación desagradable y sustituirlo por otro que evoque una imagen más tranquilizadora. Operador verde en lugar de barrendero. Prueba de ello es la psicolingüística (o psicología del lenguaje) que se ocupa principalmente de todos aquellos procesos que implementa el cerebro para comprender y producir el lenguaje. En conclusión, antes de pasar a ver cuáles son los principios de la persuasión, podemos establecer que saber comunicar de manera persuasiva significa ser capaz de ganar la atención, el interés y la confianza de quienes están frente a nosotros.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 16",
        "realExample": "de primacía es siempre crucial, el efecto de actualidad adquiere importancia cuando concluimos con una llamada a la acción: por ejemplo, \"¡Compre ahora!\" o \"Deje su número de teléfono y nos comunicaremos con usted\". Dependiendo de cómo pretendamos concluir nuestro proceso persuasivo, todo el proceso debe estructurarse, con más énfasis en los momentos más importantes. Por ejemplo, si planeamos concluir con una invitación a realizar una determinada acción, podemos imaginarnos estructurarla colocando los mensajes más importantes al principio y al final del proceso.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": "las tiendas? El principio de escasez es uno de los más poderosos y utilizados en marketing. Pero, ¿por qué tiene tanto éxito? Hay dos razones muy concretas. Podemos empezar diciendo que la gente ama la exclusividad. Si un artículo tiene disponibilidad limitada, significa que no todo el mundo puede tenerlo y que a la gente le encanta tener artículos que otras personas no pueden tener. La primera razón por lo tanto está muy relacionada con la emocionalidad de una persona que, por ejemplo, imagina que puede lucir su nueva compra incluso antes de haberla comprado, por supuesto será envidiado por todos aquellos que no pudieron conseguirlo a tiempo. La segunda razón está relacionada con el valor del producto. Un producto raro es un producto de mayor valor. Esto no es una verdad absoluta pero es exactamente el mensaje que nos llega a la mente cada vez que nos encontramos ante un producto en disponibilidad limitada. Por tanto, la percepción que tenemos del valor de un producto también varía según su disponibilidad. El comercio electrónico siempre muestra la disponibilidad de un producto y muy a menudo nos encontramos con las palabras \"solo queda...\". Incluso en las tiendas físicas, los dependientes suelen acudir a la computadora para informarnos sobre la disponibilidad de un producto. Que la escasez afecta el valor también es evidente para aquellas personas que suelen intentar pedir un descuento sobre el precio. Cuando tienen el último artículo disponible frente a ellos, estas person",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 20",
        "realExample": "razonablemente válidas y hacer una elección se vuelve más difícil.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 2",
        "realExample": "so. Sin embargo, es bueno comenzar este viaje con la conciencia de estar entrando en un territorio lleno de trampas. Definición Definimos manipulación mental como una conducta contraria al principio ético y dirigida a inducir en la otra persona necesidades, deseos o conductas específicas que sean independientes de su voluntad. A menudo, la manipulación mental actúa sobre la fragilidad de la víctima (culpa o deseo de aprobación). La persona que manipula lo hace exclusivamente para lograr un objetivo establecido, no necesariamente para hacer daño. Manipulación y manipulación mental consciente Para entender la manipulación mental, es necesario comenzar de nuevo desde el segundo capítulo del libro \"Claves efectivas para la persuasión\", donde definimos la diferencia entre persuasión y manipulación. A algunas personas les puede parecer obvio pero, con demasiada frecuencia, las personas tienden a confundirlas entre sí y, sobre todo, las imaginan como mundos misteriosos y peligrosos, cuando en cambio muchas técnicas las encontramos frente a nosotros en nuestra vida diaria. Hemos identificado tres diferencias principales entre la persuasión y la manipulación: Intenciones. Transparencia. Beneficios. En general, la persuasión tiene un propósito positivo, la persuasión tiene en el corazón el bienestar de la persona, la persuasión es transparente y sobre todo quienes la experimentan se benefician de ella. De hecho, podemos persuadir a una persona que vive junto al mar para que se compre u",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 12",
        "realExample": "más. Personas que siempre quieren mostrar una imagen positiva de sí mismas. Entre las personas con problemas, las personas con depresión son fácilmente manipuladas. Una vez que caen en la trampa, no pueden salir por sí mismos y necesitan ayuda externa. Con el paso del tiempo, las víctimas desarrollan nuevas creencias y rechazan cualquier punto de vista diferente: No pueden imaginar su vida lejos de la de su manipulador. Su propósito es cuidar al manipulador descuidándose a sí mismos. Confundir amor y violencia. Sólo quedan satisfechos si se dan cuenta de que han satisfecho al manipulador.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m10",
    "bookNumber": 10,
    "title": "Proposito De La Manipulacion Mental",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "Propósito de la manipulación mental Según la Psicología Oscura, en casi todos los casos, un manipulador se ve obligado a realizar sus acciones con fines personales. Estas motivaciones pueden ser económicas, afectivas, sexuales, religiosas y, en todo caso, sean las que sean, presuponen un objetivo definido desde el principio. En consecuencia, la manipulación mental casi siempre se lleva a cabo bajo el impulso de un motivo tanto racional como emocional. Solo un porcentaje cercano a cero (0,01%) serían casos en los que la víctima sufre manipulación mental sin un objetivo definido. Manipulación pasiva y activa ¿Es realmente posible el control mental? No hay una respuesta definitiva a esta pregunta. La realidad es que la pregunta es controvertida y hay dos puntos de vista distintos: - Manipulación mental vista como un acto pasivo. - Manipulación mental vista como un acto activo. Los partidarios de la primera teoría son aquellos que creen que el control mental es posible pero solo porque hay individuos débiles o con baja autoestima que son propensos a depender psicológicamente de otras personas. Estos individuos débiles, abrumados por pensamientos, problemas personales y estrés, prefieren delegar su vida en otras personas que pueden tomar decisiones en su lugar. Como resultado, es fácil para ellos ser víctimas de personalidades fuertes y líderes carismáticos, independientemente de si son líderes positivos o negativos. Dentro de este grupo de personas débiles también están todos aqu",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "s pensamientos y las acciones de cualquier persona. Sin embargo, de la misma manera, los partidarios de esta tesis señalan que las personas que son capaces de manipular a las personas son en la mayoría de los casos individuos predispuestos con connotaciones psicopáticas. En consecuencia, vemos que, en ambas tesis, de un lado o del otro todavía hay una persona problemática.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 5",
        "realExample": "les son los canales a través de los cuales es posible manipular la mente humana y transformar su percepción de la realidad? 2. Cuál es el medio a utilizar: idioma. Sin entrar demasiado técnicamente en PNL (que será el tema de un nuevo libro), aquí nos basta con entender cómo funciona. Puedes imaginar tener dos tipos diferentes de realidad con los que lidiar: El primer tipo es la realidad que nos rodea. El segundo tipo es la realidad que creamos con nuestros pensamientos, nuestras creencias y nuestras opiniones. La primera realidad la podemos ver, podemos tocarla y podemos sentirla. Es todo lo que nos rodea y con el que podemos interactuar utilizando nuestros sentidos. La segunda realidad es una especie de realidad virtual porque físicamente no existe pero tiene una forma solo dentro de nuestra cabeza. Es precisamente en la segunda realidad donde se interesa el manipulador porque es manipulable y moldeable. Cambiar la realidad presente en el subconsciente de una persona equivale a afectar incluso la primera forma de realidad: como consecuencia, la víctima tiene una visión distorsionada de lo que le rodea. Antes de pasar a ver algunas de las técnicas empleadas en Programación Neurolingüística, invito a quienes quieran saber más sobre la PNL a leer al que creo que es el antepasado de esta técnica y que la anticipó por más de dos décadas. Estoy hablando de un cirujano estético estadounidense, Maxwell Maltz, que publicó un libro de obra maestra en 1960: \"Psicocibernética\". También",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 7",
        "realExample": "a víctima toda su autoridad. La agresión física ocurre cuando se avanza el estado de manipulación.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m14",
    "bookNumber": 14,
    "title": "Manipulacion Como Reconocerlo Y Defenderse",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "Manipulación: cómo reconocerla. Quien es víctima de un manipulador pierde su personalidad y capacidad de decisión. Una persona manipulada acaba viviendo su vida marcada por tres emociones: 1. El deseo de aprobación. 2. Adicción al manipulador. 3. El terror del abandono. Para satisfacer sus deseos está dispuesta a todo, a renunciar a sus propias ideas, renunciar a su propia visión de la realidad, a sufrir conductas degradantes, a aislarse del mundo y de sus seres queridos, hasta el punto de sufrir violencia verbal y física. Con el paso del tiempo, la víctima que cae en la trampa de un manipulador comienza a mostrar claros signos de su precaria condición mental. El manipulador degrada a su víctima y la desestabiliza profundamente. La víctima comienza a vivir en la búsqueda incondicional de su aprobación, lo idealiza como la única autoridad y por lo tanto termina renunciando a su vida real, sus deseos y sus puntos de vista. El hecho de estar en un estado pasivo la hace aceptar de buen grado incluso la conducta despectiva de su manipulador, cayendo cada vez más bajo y renunciando día tras día a su propia personalidad. A medida que pasa el tiempo, más señales deja el manipulador en la mente de la víctima y reconocerlas puede ser determinante para ayudarla. Pero incluso la propia víctima puede reconocerlas realizando un análisis sincero. Veamos cuáles son las señales que nos envía nuestro cuerpo: Enfado. La víctima puede mostrar ataques de ira, un arrebato inconsciente para intenta",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "e dé cuenta de que ha sido manipulado, no debe correr el riesgo de intentar razonar con el manipulador. Es una situación que se da muy a menudo porque, en el inconsciente de la víctima, se ha establecido un sentimiento de amor hacia su torturador y por tanto siempre existe un miedo al abandono que lleva a tomar decisiones equivocadas. Hay que renunciar a cualquier enfrentamiento abierto y huir de las discusiones porque estas terminarían favoreciendo al manipulador.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m15",
    "bookNumber": 15,
    "title": "Violencia Psicologica Y Como Convertirse En Manipulador",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "Violencia psicológica contra la mujer Lamentablemente, es imposible no abordar este tema tan complejo sin dar espacio a la violencia psicológica contra la mujer. Si bien la agresión psicológica en la pareja también la puede realizar la mujer contra el hombre, la violencia del hombre contra la mujer es mucho más frecuente. Lamentablemente, son solo aquellos casos en los que la manipulación psicológica degenera en violencia física los que son noticia, pero hay muchas situaciones que quedan en la sombra. El manipulador emocional puede llevar distintas máscaras (el desinteresado, la falsa víctima, el mentiroso crónico, el mentor, el parásito...) pero creo que la mejor y más eficaz clasificación es siempre la dictada por el Dr. Robin Stern: el intimidante, el seductor y el buen chico. El intimidador aprovecha las amenazas y apunta al apocalipsis emocional con escenas de gritos y ofensas. Tampoco faltan las amenazas de abandono y cualquier cosa que pueda llegar a golpear las inseguridades de su víctima. El seductor es inicialmente gentil y atento. No es fácilmente reconocible y a menudo se lo confunde con la pareja perfecta. Por lo tanto, puede engañar hábilmente a su víctima durante mucho tiempo con la única intención de satisfacer sus deseos. Desde fuera se le ve como una persona cariñosa y cuando la víctima se da cuenta del engaño ya es demasiado tarde. Las primeras señales de advertencia son la sensación de inadecuación o desatención. El buen chico se presenta similar al seduct",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 2",
        "realExample": "nsciente se vuelva útil y no un obstáculo para la consecución de tu objetivo. ¡Esto es válido tanto para esto como para todas las situaciones de la vida normal! Por eso, el segundo paso para lograr la hipnosis secreta es evitar el factor crítico. [REVISAR: TEXTO EN INGLÉS] Dado que este paso depende exclusivamente de nosotros y no de la persona a la que se intenta hipnotizar, a primera vista parece ser el más fácil. En realidad, es uno de los más complejos porque actuar con el subconsciente, las creencias y los hábitos propios es mucho más difícil que manipular la mente de los demás. La hipnosis conversacional se basa en pensamientos, palabras, lenguaje corporal y tono de voz, todos estos elementos trabajan juntos en armonía. Para obtener la máxima concentración del sujeto separándolo de todo lo que le rodea, es necesario que la persona que intenta la hipnosis secreta esté concentrada y desapegada de sus pensamientos y problemas. Pero es imposible que alguien crea una cosa mientras piensa en hacer algo completamente diferente al mismo tiempo. Por ejemplo, no podemos imaginar que estamos hablando de relajación o imaginar que hacemos que alguien se relaje mientras damos golpecitos nerviosos con los dedos sobre el escritorio. Activación de una respuesta inconsciente El tercer paso es activar una respuesta inconsciente del sujeto. Esto es lo que nos prueba si hemos sido capaces de comunicarnos con el inconsciente y por tanto si hemos sido capaces de llevar al sujeto a un estado h",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "ipnótico. Hay diferentes tipos de respuestas inconscientes; no es necesariamente un tipo de respuesta \"clásica\" que es la respuesta clásica a una pregunta. Una respuesta inconsciente también puede ser emocional, es decir, el sujeto puede mostrar emociones que a menudo son ajenas al entorno en el que se encuentra. En ausencia de una respuesta inconsciente sería inútil continuar porque sería una pérdida de tiempo seguir trabajando con ese tema en particular. Llevando al inconsciente al resultado deseado El logro del resultado deseado es obviamente la etapa final. Sin embargo, este es precisamente el momento en que el sujeto se encuentra en un estado hipnótico, el momento en que se ha creado la conexión con su subconsciente y por tanto, es posible lanzar una sugestión hipnótica en dirección a su mente inconsciente.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 3",
        "realExample": "iente de su mente o la inconsciente. El derecho maneja el lado más \"creativo\" y consciente mientras que el izquierdo es el lado \"práctico\" y es manejado por el subconsciente. Durante un intento de hipnosis secreta, es aconsejable observar cuidadosamente la mirada de la otra persona. Si los ojos apuntan hacia la izquierda (la derecha del observador), entonces la persona está accediendo a la información presente en su subconsciente y ha abandonado temporalmente su ser consciente. Incluso una mirada fija en un objeto (incluso la famosa mirada fija al espacio) es una señal interesante que nos hace comprender si la mente inconsciente está activa. Estas son señales que indican que es posible intentar enviar una sugerencia hipnótica. 4 Haciendo hincapié en la izquierda La subdivisión de la mente consciente y subconsciente en los dos hemisferios permite explotar una técnica muy interesante, aunque sea bastante compleja de poner en práctica. De hecho, requiere mucha práctica porque el momento y la precisión de su aplicación es decisivo. La técnica consiste en hablar con nuestro interlocutor e intentar obtener un contacto visual estable. En ese punto, puedes elegir enfocarte y hablar al lado derecho del sujeto (el consciente) o al lado izquierdo (el inconsciente). ¡La conversación no puede ser espontánea porque es necesario saber qué decir al lado derecho y qué decir al lado izquierdo! Intento explicarlo con un ejemplo. \"Entiendo que tenga dudas sobre el producto, pero ¡Mírame!, creo q",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "os opciones posibles, excepto que la misma pregunta es ilusoria ya que solo hay una opción posible. \"¿Comerás de todo o quieres irte a la cama sin comer?\" En este caso la pregunta tiene dos opciones pero la segunda, que también implica irse a dormir, se descarta desde el principio. Otro ejemplo podría ser \"¿Quieres ir a dormir ahora o en 10 minutos?\". Ante esta pregunta, el niño tiene la ilusión de poder elegir, pero la realidad es que es el padre quien está decidiendo que se acostará en diez minutos. 8 Ambigüedad \"Los oradores son más vehementes cuando su causa es débil.\" (Cicerón) La técnica de la ambigüedad es una de las que más experimentamos cada día, yo la llamo la técnica del político. El uso de discursos ambiguos es una forma común en la que muchos líderes de partidos o dictadores ávidos de poder hipnotizan a las masas. Muchos de los llamados grandes líderes políticos no son más que hábiles oradores que logran eludir el pensamiento crítico. La mayoría de las veces, los discursos de los líderes políticos carecen de lógica. Están llenos de ambigüedades y consignas vagas que no tienen otro propósito que despertar las emociones de la multitud. Es poco probable que prevalezca un líder lógico que utiliza un discurso claro e inequívoco y que no despierta las emociones de la gente. Esto sucede porque la mente consciente no tiene ninguna dificultad para comprender el significado de frases simples y lógicas. Por el contrario, también suelen aburrir al oyente. En cambio, el uso",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m21",
    "bookNumber": 21,
    "title": "Libro 4 Lenguaje Corporal Revelado",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "--- LENGUAJE CORPORAL REVELADO Introducción ...Y así, hemos llegado a la tercera parada de este largo y tortuoso viaje hacia el descubrimiento del hombre, de su capacidad de razonar y de dejarse influir, de su capacidad de ser racional, calculador, reflexivo y luego en un instante transformarse en una persona incoherente, contradictoria y confusa. En los libros anteriores intenté de forma sencilla y directa sacar a la luz la mayoría de las técnicas utilizadas para persuadir y/o manipular a un individuo para que realice un gesto o una acción que no sea voluntaria. Para hacer esto, abordé la primera parte del camino dentro de la mente humana, destacando en particular por qué una persona reacciona de manera predecible a ciertos estímulos externos. La tercera ley de la dinámica, o principio de acción y reacción, establece que toda acción corresponde a una reacción igual y opuesta. Lo mismo parece suceder en la mente de cada uno de nosotros. Sufrimos acciones, estímulos externos que nos llevan a hacer una determinada elección en la misma dirección que el estímulo pero de forma contraria a nuestra voluntad inicial. Además, especialmente cuando me detuve en la manipulación mental, presté atención a la fase de estudio de la víctima, esa fase en la que el manipulador identifica los puntos débiles para convertirlos en puntos fuertes de su acción de manipulación. La manipulación mental requiere un conocimiento profundo de la víctima, así como las técnicas a adoptar. La persuasión requie",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 2",
        "realExample": "re principalmente el conocimiento de las técnicas a utilizar de acuerdo con el grupo objetivo de personas que queramos acercarnos. Ambos presuponen acciones dirigidas a cambiar la percepción de los demás y su capacidad de elección. El aprendizaje del lenguaje corporal es un conocimiento complementario a los anteriores porque no tiene el objetivo de actuar sobre la mente de nuestro interlocutor sino de comprender cuáles son, en un momento dado, los sentimientos y emociones reales con el que estamos interactuando. Para simplificar, podemos decir que si bien la persuasión y la manipulación son conductas activas porque requieren una serie de acciones a realizar en primera persona, la lectura del lenguaje corporal requiere una actitud generalmente pasiva. No debemos hacer nada más que observar y ajustarnos en consecuencia. Podría haberte hablado de los opuestos, por un lado el comportamiento activo y por el otro una forma de ser pasivo. En cambio, hablé de conocimientos complementarios. Le daré un ejemplo simple: suponga que está proponiendo un producto para vender a un cliente potencial. 1. ¿Crees que sería ventajoso saber si has logrado atraer la atención de esa persona después de utilizar algunas técnicas persuasivas? 2. ¿Le interesan los argumentos que está presentando o le molesta? 3. ¿Sería una ventaja saber el momento exacto para realizar una venta? Incrementar las habilidades en el conocimiento del proceso de comunicación a través de la comprensión y el análisis de los ges",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "tos, conduce inevitablemente a una enorme ventaja en muchas situaciones, todos los días y no solo en el trabajo. De hecho, esto no solo se aplica a los vendedores. En la vida cotidiana todos nos enfrentamos a diversos problemas, desde la falta de comprensión de las penurias de nuestros hijos, hasta las inseguridades hacia nuestra pareja, desde las discusiones en el lugar de trabajo y hasta los malentendidos con los amigos. El lenguaje corporal dice más de lo que puedes creer. Aprender los conceptos básicos también significa poder interactuar positivamente con todos. Investigación en U.C.L.A. (Universidad de California, Los Ángeles) ha demostrado que solo el 7% de la comunicación se basa en las palabras que decimos. En cuanto al resto de la comunicación, el 38% proviene del tono de voz y el 55% restante del lenguaje corporal. Aprender a tomar conciencia e interpretar que el 55% nos puede dar una gran mano a la hora de interpretar a quien está frente a nosotros. Saber leer en el cuerpo de otra persona significa no solo aumentar nuestras habilidades, sino también volvernos más humanos y poder reflejarnos en nuestros semejantes. Kinésica La kinésica estudia \"cualquier acción capaz de enviar una señal visual a un observador [...] y de comunicarle cualquier información\". (Desmond Morris) A diferencia del lenguaje verbal, el lenguaje corporal, al no ser voluntario, no permite la ambigüedad o la ironía. Salvo algunos casos particulares de personas expertas en señales corporales, como",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 4",
        "realExample": "políticos o buenos vendedores, siempre comunica autenticidad y verdad. El gesto corre paralelo al lenguaje verbal e, inconscientemente, lo enfatiza, reduce o incluso lo contradice. Gesticular no es un simple hábito, no es un conjunto de movimientos sin sentido, los gestos contribuyen a la elaboración de significados verbales en el cerebro. La kinesia (del griego kinesis, movimiento) es la ciencia que estudia el lenguaje corporal. Por lenguaje corporal entendemos toda la gestualidad que somos capaces de expresar, ya sea fácilmente observable, como un gesto de la mano, o más sutil, como cambiar el tamaño de la pupila. El conjunto de todos los gestos se divide en cuatro áreas macro: Gestos ilustrativos. Gestos deícticos. Gestos reveladores. Gestos analógicos. Los gestos del ilustrador son aquellos que a través de la imagen describen el concepto. El ejemplo más simple de comprensión es el del cine mudo, donde los actores, ante la ausencia de posibilidad de diálogo, debían expresarse exclusivamente en gestos. Los movimientos deícticos son movimientos coverbales y son gestos indicadores que suelen acompañar a palabras como \"aquí\", \"esto\", \"yo\", \"tú\", etc. Pueden ser tanto movimientos voluntarios como involuntarios e indicar algo concreto. Los gestos reveladores son formas de deslizamiento de la lengua que suelen estar condicionadas por la cultura a la que se pertenece. El gesto analógico es el que en cambio se origina en nuestro inconsciente, de nuestros pensamientos y emociones,",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "el gesto que realmente revela lo que somos al instante. Este último será el que vamos a analizar. Cómo adquirir la capacidad de leer gestos Comencemos esta tercera parte del descubrimiento de la mente humana entendiendo una cosa fundamental: ¿cómo adquirimos la capacidad de leer el lenguaje corporal? “Es más fácil para un italiano gesticular sin hablar que hablar sin gesticular.” (Jean-Paul Malfatti) Si eres italiano entenderás bien cómo conocer el lenguaje corporal puede ser incluso más importante para ti que un ciudadano de cualquier otra nación y creo que el pensamiento de Jean-Paul Malfatti es perfecto para comenzar este viaje con realismo y un toque de ironía. Pero comencemos desde el principio. ¿Cómo llegamos a mapear los gestos de una persona a identificar esos sutiles matices en una mirada o una sonrisa que aún hoy nos permiten reconocer su significado? A fines del siglo XIX, Henry Morton, presidente del Instituto de Tecnología Stevens, pasó a la historia con una declaración de solo tres palabras: \"¡Un completo fracaso!\" ¿A qué se refería uno de los científicos más conocidos de la época? ¡Nada menos que la invención de la bombilla de Thomas Edison! Henry Morton estaba seguro de que sería imposible canalizar y transportar electricidad a grandes distancias. Pero este es solo uno de los grandes errores de juicio de la historia. A principios de la década de 1900, la invención de la bicicleta ya parecía haber llegado a un callejón sin salida, porque según los expertos era",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "un medio de transporte peligroso e incluso poco práctico para el uso del día a día. ¿Y qué hay de las predicciones del New York Times? En 1902 afirmó que el coche tampoco era práctico y que su precio nunca sería asequible. Pero en 1985 fue aún más lejos, prediciendo la futura inutilidad de las computadoras portátiles debido a su peso, costo y poca duración de la batería. El propio gol de Kodak de 1995 también fue rotundo. No todo el mundo recuerda que la Kodak DC40 fue la primera cámara digital que apareció en el mercado, pero fue inmediatamente retirada del mercado y la empresa decidió seguir centrándose en la película. En 2012, Kodak se declaró en quiebra solo porque no había probado su revolucionario producto durante el tiempo suficiente. Pero también hay ejemplos de lo contrario. ¿Quién no conoce Coca Cola, por ejemplo? La bebida más famosa del mundo no está libre de rotundos errores. En 1985 Coca Cola lanzó al mercado New Coke con un sabor diferente y más dulce de lo habitual. La reacción de los consumidores fue tan inmediata que New Coke fue retirada del mercado después de solo tres meses. Todos estos casos particulares nos hacen comprender que nada es seguro hasta que tengamos la oportunidad de obtener una determinada respuesta: nuestras opiniones deben ser confirmadas en el mundo real para salir del campo de las hipótesis. Del mismo modo, el estudio del lenguaje corporal es el resultado de un largo proceso de estudio y pruebas no solo en el laboratorio sino en la vida",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 7",
        "realExample": "cotidiana. El mejor ejercicio que se puede hacer para aprender este arte, luego de aprender lo básico, es observar a todos los que nos rodean, posiblemente yendo a lugares donde se pueda conocer a diferentes personas. El camino a recorrer será largo y exigente, a veces divertido, triste o lleno de sorpresas. Cuando esté en el camino correcto, lo notará fácilmente. ¿Recuerdas lo que escribí al final de la introducción? Saber leer en el cuerpo de otra persona significa no solo aumentar nuestras habilidades, sino también volvernos más humanos y poder reflejarnos en nuestros semejantes. Repito: reflejarnos en nuestro prójimo. “El inconsciente de un ser humano puede reaccionar ante otro sin pasar por el consciente” (Sigmund Freud) ¿Por qué a veces reaccionamos impulsivamente a un gesto sin siquiera darnos cuenta? Sigmund Freud, neurólogo austriaco y fundador del psicoanálisis, lo explica en su teoría del inconsciente. Obviamente, este no es el momento ni el lugar para abordar toda la teoría del inconsciente, pero podemos extraer algunas lecciones de lenguaje corporal. Inconscientemente el ser humano es capaz de reconocer los gestos de un prójimo y de ellos comprender pensamientos e intenciones. Si reconoce en él una intención hostil entonces su subconsciente se activará automáticamente para ofrecer una respuesta adecuada que puede ser tanto defensiva como ofensiva (según el grado o tipo de hostilidad detectada). Esta teoría ha sido probada varias veces y, durante determinadas pru",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "ebas de laboratorio, se ha observado a personas que inconscientemente logran ponerse en el lugar del otro, incluso sintiendo las mismas emociones. Piense en todas las ocasiones en que, sentado en un banco en el parque, observó a una persona reír y se dio cuenta de que usted también sonreía. O ese momento en el que observó una situación violenta y sintió que sus ojos se apretaban en una mueca. Imagínese durante una película de terror, en el momento exacto en que una mujer pálida y asustada, en medio de la noche, camina sola hacia una vieja casa abandonada. Su rostro está en primer plano y muestra todo su terror. De repente, un ruido agudo detrás de ella, se da la vuelta y el reflejo de un cuchillo golpeándola... mientras aprietas los puños o te agarras a la manta. Inconscientemente sufres las mismas emociones que el protagonista de la escena y reaccionas con tu cuerpo como si estuvieras en el centro de la escena. Pero, ¿qué pasaría si vieras esa escena diez veces? Con cada nueva visión podrías captar algún detalle nuevo y, al mismo tiempo, comenzarías a razonar, es decir, solo usarías la parte consciente de tu mente. Observarías la escena de una manera cada vez más desapegada y, ahora desprovisto de ese estado emocional inicial, podrías concentrarte racionalmente en cada aspecto: la música, los gestos de la chica, el entorno. Volvamos a la pregunta inicial: ¿cómo adquirir la capacidad de leer el lenguaje corporal? Respuesta: prueba y practica. Limitarse a la teoría es como pon",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 9",
        "realExample": "er en el mercado un nuevo snack de miel sin haberlo probado con un grupo de niños y esperar, cruzando los dedos (gesto de expectación), el feedback definitivo del mercado. Pero, ¿cómo es posible probar y practicar? La forma más sencilla de realizar la prueba es con familiares o amigos cercanos. Con ellos puedes ser franco e intentar adivinar sus pensamientos, entender si un amigo está realmente interesado en lo que dices o si tu pareja tuvo un mal día en el trabajo. Con ellos puede ser honesto y directo y tener cierta retroalimentación sobre sus habilidades de lectura corporal. Puedes hacerlo en cualquier lugar, pero el consejo es que elijas lugares donde puedas encontrar diferentes personas y personalidades. Por ejemplo, podría ir al mercado, sentarse en un banco y mirar. Es posible que desee echar un vistazo a un puesto vacío donde nadie se ha detenido durante demasiado tiempo. Detrás del soporte de exhibición, sentada en una silla, hay una mujer con los dedos entrelazados y los pulgares bailando entre ellos. Ella mira hacia abajo y probablemente esté reflexionando sobre el hecho de que hoy no traerá el día a casa. El suyo es un flagrante estado de nerviosismo porque se complementa con una postura tensa, espalda recta y tobillos tensos. En cambio, todavía no es una mujer derrotada y está pensando en cómo resolver sus problemas. Ella no está aburrida ni desanimada; su espalda no está curvada y sus codos no descansan sobre sus piernas como si estuvieran cargando demasiado pes",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 10",
        "realExample": "o para ella. Entonces, la mirada podría llevarte a otro lugar. De pie junto a la puerta frente a ti, descansando de espaldas, con una pierna en el suelo y la otra doblada y con la suela pegada a la pared, hay un chico, muy cómodo mientras habla por su teléfono móvil. La cabeza inclinada del costado donde está el teléfono y el hombro un poco levantado, casi protegiendo el celular, delata el hecho de que, muy probablemente, está hablando con su novia. Su rostro está sereno, sonríe y sus ojos se entornan. Está abrazando su teléfono celular como si tuviera a la persona con la que está hablando a su lado. En este caso puedes llegar a imaginar cómo ella también, muy probablemente, está muy enamorada de él. Luego hay un cliente parado frente al puesto de frutas asintiendo con la cabeza hacia su teléfono móvil y señalando de una caja de frutas a otra. De vez en cuando, levanta la cabeza, como si estuviera molesto, luego regresa con la barbilla en el pecho para asentir. Obviamente está aburrido, no puede quedarse quieto y cambia su peso de un pie al otro. Aunque asiente constantemente, le gustaría terminar esa conversación lo antes posible. Probablemente esté hablando por teléfono con su esposa dándole los últimos consejos sobre compras, o con uno de sus compañeros de trabajo quejándose de algo. Si hubiera sido su superior, habría asumido una postura más rígida, con los pies firmemente en el suelo y habría asentido con la cabeza en alto, pero muchas menos veces, porque habría prestado",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 11",
        "realExample": "más atención a lo que escucha. Como si su jefe hubiera estado allí para verlo. ¡Ahora mira! Una señora se alejó de ese puesto con un pequeño sobre en la mano. En el puesto sonríe y se frota las manos. En ese sobre puede haber algo pequeño pero muy caro, así que está contento porque hizo una buena venta. Pero su mirada no está en la caja registradora, sino que sigue a la dama mientras se aleja. Ella pasa frente a ti y notas que tiene las mejillas rojas, estira el paso y, sonriendo, se pasa la mano derecha por el cabello. Quién sabe, tal vez la felicidad del encargado del puesto dependa de otra cosa... Ahora, eso es lo que quiero decir con práctica. Al principio seguro que te verás reflejado en las personas que observas, te encontrarás moviendo tus labios al observar sus labios, o mostrarás gestos de nerviosismo cuando tengas frente a ti a una persona que tiene que hacer una decisión difícil, o si la observa mientras está sentada en la sala de espera de un dentista. La práctica sirve no solo para aprender el arte del lenguaje corporal sino también para aprender a utilizar más la parte consciente que la inconsciente de nuestra mente, para observar mejor en lugar de reflejarnos en los gestos de otras personas. Poder observar con espíritu desapegado te permitirá cometer menos errores de evaluación porque no te dejarás guiar por los sentimientos sino que analizarás las situaciones que pasarán por delante de tus ojos utilizando la parte racional de tu mente. Gestos y gesticulacione",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 12",
        "realExample": "s aislados Podemos definir el conjunto de gestos como un lenguaje involuntario real y muy bien podríamos compararlos con el alfabeto que todos conocemos. Pongamos un ejemplo. Sabes que A, E y O son tres vocales. También sabes que F, H y M son tres consonantes. Estas letras aisladas unas de otras, no pueden darte más información. Las conoces, pero no tienes idea del mensaje que quieren darte. Pero cuando se presentan juntos y en el orden correcto, \"TENGO HAMBRE\", tienes una idea clara del mensaje recibido. Del mismo modo, un gesto debe analizarse dentro de un conjunto de gestos. Ver a una persona saludarte de lejos con dos dedos, índice y meñique, bien estirado y con expresión seria tiene sentido. Sin embargo, si ese gesto va seguido de una sonrisa, adquiere un significado completamente diferente. Me mantendría alejado de la primera persona. Más simple aún: si una persona se despide de ti con la mano abierta, nunca podrás decir si está feliz de que te vayas o por el contrario, lo lamenta, sin mirar la expresión de su rostro. La despedida con las manos abiertas es un gesto de cortesía pero no siempre lo que ves a primera vista... es. De hecho, los gestos también pueden ser opuestos entre sí, como una risa nerviosa o un grito de alegría. El ejercicio constante es la base tanto de la comprensión del lenguaje corporal como de la capacidad de comprender las señales que se nos envían en el menor tiempo posible. De hecho, cuanto menos tiempo disponemos, más difícil es interpretar a l",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 13",
        "realExample": "a perfección lo que inconscientemente quiere decirnos nuestro interlocutor. Sin embargo, antes de pasar al ejercicio práctico, es necesario tener una visión general de los principales gestos con los que enviamos señales involuntariamente al mundo exterior, una base sólida sobre la que podemos construir nuestra capacidad y técnica en la lectura corporal.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m22",
    "bookNumber": 22,
    "title": "Gestos Basicos Para Aprender",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "--- Gestos básicos para aprender Como todo en la vida, cuanto más sepamos, mejor; cuanto más estudiemos, mejor será nuestro rendimiento; cuanto más escuchemos y aprendamos, mejor serán nuestros resultados de competencia. Lo mismo es cierto si desea alcanzar un buen nivel en el conocimiento (o en el reconocimiento) de los gestos involuntarios. Sin duda, el estudio y la formación le traerán buenos resultados, pero hay otra buena noticia: pensé en dividir este libro en varias partes para evitar que se sienta sobrecargado de información. A veces las personas más perezosas (puedo asegurar que cada uno de nosotros tiene un buen porcentaje de pereza) luchan por comprometerse porque no pueden obtener resultados inmediatamente evidentes. Dificultades, largos periodos de tiempo y la tendencia a procrastinar hacen que incluso los proyectos iniciados con las mejores intenciones se abandonen. Para evitar esto, empezaré hablando de los principales gestos básicos que puedes entrenarte a reconocer de inmediato y que te darán una satisfacción inmediata cuando intentes leer a la gente entre la multitud. Brazos y piernas cruzados. Indican una clara resistencia a sus ideas. Los brazos y piernas cruzados son barreras físicas que sugieren que la otra persona no está abierta a lo que está escuchando o recibiendo. Es una señal tan importante que supera con creces cualquier otra señal que la gente pueda intentar enviarle. Incluso si sonríen y fingen tener una conversación agradable, sus brazos y pier",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 2",
        "realExample": "nas cuentan otra historia. El experimento realizado por Gerard I. Nierenberg y Henry H. Calero logró resultados inequívocos. En una muestra de más de 2.000 negociaciones seguidas, ninguna terminó en un acuerdo positivo cuando una de las personas involucradas cruzó las piernas durante la negociación. Psicológicamente, las piernas o los brazos cruzados indican que estás frente a una persona que está apegada mental, emocional y físicamente a lo que se le ofrece. Cruzar los brazos o las piernas no son gestos intencionales, sino que son una reacción automática de nuestro cuerpo ante una situación particular y se consideran señales fuertes y reveladoras. Sonreír. “La vida es como un espejo: te sonríe si le sonríes.” (Jim Morrison). A lo largo de los siglos, los artistas nos han mostrado la estrecha relación entre los ojos y el corazón, destacando la capacidad de transmitir, por ejemplo, alegría o tristeza a través de una mirada. En la cita de Jim Morrison queda claro cómo una sonrisa real es la que comienza con los ojos. No nos dejemos engañar por la imagen estereotipada de una gran sonrisa con dientes blancos: la boca puede engañar. Las sonrisas reales hacen que los ojos se arruguen, creando las famosas patas de gallo, las pequeñas arrugas que parten de la punta exterior del ojo y se extienden hasta la sien. Es imposible mentir con tus ojos. A menudo encontrarás sonrisas falsas en el camino, aquellas de circunstancias en las que los labios se abren mostrando los dientes: un ojo de",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "scuidado podría caer en una trampa. La próxima vez que quieras saber si la sonrisa de alguien es genuina, busca los pliegues en las esquinas de los ojos. Si no están ahí, esa sonrisa esconde algo. El efecto espejo. Conocer este gesto corporal involuntario en particular puede ser muy útil, especialmente para todos los vendedores o para aquellos que a menudo están en condiciones de negociar o tratar con otras personas. Puede que no lo hayas notado ya, pero seguramente habrás experimentado muy a menudo que tu interlocutor ha comenzado a copiar tus gestos. A menudo te habrá pasado lo mismo, es decir, encontrarte replicando los gestos de otras personas. Es como tener una especie de espejo frente a ti. Una persona se pasa una mano por el cabello y la otra hace lo mismo, una se cruza de brazos y la otra persona hace lo mismo. Darnos cuenta de que la persona con la que estamos hablando ha comenzado a copiar nuestro lenguaje corporal es algo bueno. De hecho, el reflejo del lenguaje corporal es algo que hacemos inconscientemente cuando establecemos un vínculo positivo con la otra persona. Es una buena señal de que la conversación va bien y que la persona con la que estamos hablando es receptiva a tu mensaje, sintonizada en la misma longitud de onda. Anticipé que esta forma particular de gesto sería muy útil para los vendedores: de hecho, cuando está negociando, el efecto espejo puede mostrar el momento exacto en que la persona con la que está negociando está lista para cerrar un trato",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 4",
        "realExample": "de manera positiva. Postura. Las señales provenientes de la postura son probablemente las más fáciles de detectar, son las que nos dan una impresión general de la persona que tenemos frente a nosotros. Una cosa que quizás no sepa es que el cerebro humano está configurado para comparar el espacio ocupado por una persona con el poder que ejerce. Una postura erguida con el pecho hacia afuera y los hombros hacia atrás es un ejemplo clásico de una persona poderosa. Sin duda es una persona que está tratando de maximizar el espacio que ocupa y mostrarse de una manera impresionante. Muchos animales se comportan de la misma manera e inflan una parte de su cuerpo como arma defensiva, para parecer más grandes y más difíciles de derrotar. El gorila en el reino animal usa la misma actitud e infla el pecho. La imagen del gorila golpeándose el pecho con los puños y haciendo grandes gestos con los brazos es una clara ilustración de la necesidad de ocupar el mayor espacio posible para mostrar una imagen aún más impresionante (¿alguna vez has visto la película King Kong? Incluso en la ficción se exalta la combinación de los tres movimientos: de pie, pecho extendido y trazos amplios, a estos se suman otros gestos que veremos más adelante como rechinar y mostrar los dientes). Por el contrario, una persona que aprieta los hombros muestra poca personalidad pero también desconfianza hacia el mundo exterior. Una persona que se inclina (no por problemas físicos) es una persona que se derrumba sobre s",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "í misma, que pierde su forma, ocupa menos espacio y muestra su debilidad. ¿Es suficiente una postura perfecta para ser un líder? No, pero una postura correcta es suficiente para exigir respeto. Contacto visual. Si una persona miente, lo verá a través de sus ojos. Ese es un viejo dicho que se aplica aún más hoy que entonces. ¿Por qué? Probablemente se deba a que ahora todos conocen el hecho de que una persona que miente no puede mantener la vista en su interlocutor. “La lengua puede ocultar la verdad, pero los ojos, ¡nunca!” (Michail Bulgakov). Hace mucho tiempo se pensaba correctamente que una persona que apartaba la mirada de los ojos de su interlocutor durante una conversación era una persona que no tenía claridad y que probablemente mentía. Pero ahora es tan bien sabido que los \"mentirosos en serie\" utilizan la técnica inversa para dar más fuerza a sus palabras, manteniendo su mirada mucho más tiempo de lo que lo haría un antiguo mentiroso. Como citó Michail Bulgakov, ¡los ojos nunca mienten! Entonces, a menos que esté mirando a un artista de mentiras, podría distinguir fácilmente una mirada natural de una mirada forzada que generalmente se caracteriza por el hecho de que no parpadea y sus ojos están abiertos y fijos a la fuerza. Por lo general, frente a este tipo de mirada, sin embargo, el cuerpo percibe una sensación de malestar que debe escucharse de inmediato como una probable llamada de atención. Cejas. Si miras las cejas de una persona, estas pueden revelarte mucho m",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "ás de lo que crees. Las cejas levantadas pueden indicar que una persona se encuentra en un estado de incomodidad o está sorprendida por una determinada situación. Si, por el contrario, una persona está preocupada o asustada, sus cejas tienden a arrugarse más cerca de su frente. Entonces, cuando miras a una persona desde la distancia, puedes saber por el movimiento de sus cejas si está experimentando un estado emocional particular. La combinación de los gestos restantes de la cara o el cuerpo en general puede ayudarlo a reducir su hipótesis a la real. Importante es entender que, durante una conversación amistosa, las cejas no se mueven. Trate de darse cuenta de esto la próxima vez que hable con un amigo o familiar suyo. Intente criarlos usted mismo mientras charla tranquilamente con alguien: no es una cosa fácil de hacer porque no es natural. Entonces, si nota durante una conversación que la persona con la que está hablando está moviendo las cejas sin motivo aparente (asombro, incomodidad, preocupación o miedo) relacionado con la discusión, entonces puede haber algo diferente detrás de esas palabras. En general, la clave siempre es estar consciente de la discrepancia que puede existir entre lo que dice una persona y lo que le dice su lenguaje corporal. Asentir. Asentir es el gesto clásico que todos hacemos de forma involuntaria durante una conversación y generalmente significa que estamos de acuerdo con lo que nos dice nuestro interlocutor. También es un gesto útil para ganarn",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 7",
        "realExample": "os la confianza de la otra persona, por ejemplo si estamos negociando la venta de uno de nuestros productos. A la gente le gusta hablar y confiar en otras personas que están de acuerdo con ellos. A menudo, los vendedores también están de acuerdo en situaciones en las que lo ideal sería exactamente lo contrario. En este caso asienten pero luego contraatacan con un \"Sí, pero...\" o \"Estoy totalmente de acuerdo contigo, pero... \". Pero si observáramos a una pareja charlando desde afuera, sería más fácil observar tres tipos diferentes de asentir desde afuera. 1. Asentir lentamente significa prestar atención, a veces indica una disposición a fingir ser atento. La concentración no es tanto en lo que estás escuchando sino en el movimiento tranquilo impuesto por la cabeza. Está asintiendo con la cabeza a propósito para mostrar un interés falso. 2. Asintiendo a velocidad media: quienes asienten a velocidad media están realmente de acuerdo con su interlocutor y su interés es tal que el movimiento en sí es muchas veces semi-voluntario, es decir, se inicia involuntariamente y luego se acentúa voluntariamente, como si quisieran enfatizar aún más su interés. 3. Asentir con la cabeza exagerada indica ansiedad por la aprobación. Cuando le dices algo a alguien y asiente demasiado, significa que está preocupado por lo que piensas de él o que, por ejemplo, dudas de su capacidad para seguir tus instrucciones. La mandíbula. Una mandíbula apretada es un signo claro de estrés y es un signo de malest",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "ar considerable. No está necesariamente relacionado con la situación instantánea porque puede ser una reacción del cuerpo a un pensamiento que está más allá del momento actual. Una persona puede fingir estar escuchándote, pero en realidad, tiene un pensamiento que la fastidia y se manifiesta como un signo de estrés. Palmas de las manos. Abrir las palmas de nuestras manos apuntándolas hacia arriba es un movimiento involuntario que hacemos cuando demostramos ciegamente a nuestro interlocutor que puede confiar en nosotros, que somos personas honestas y sinceras. Es un gesto que fortalece nuestras palabras y nos entrega desarmados al otro, con las manos abiertas casi rogando al otro que nos asegure su confianza en lo que hemos expuesto. Mantener las palmas de nuestras manos hacia abajo, o colocarlas sobre la mesa, es un gesto que indica autoridad, fuerza y poder. ¿Cuál es el punto de poder leer el lenguaje corporal? “Toda falsedad es una máscara, y no importa qué tan bien hecha esté, siempre se puede distinguir de la cara.” (Alexandre Dumas). ¿Quieres apostar que probablemente te daré una respuesta que no esperas? Por lo general, pensamos que saber leer el lenguaje corporal puede ayudarnos a comprender a los demás. Normalmente, podría responder de una de estas formas: En la vida, puede ayudar a saber si una persona miente. En el trabajo, puede ayudar a saber si una persona está dispuesta a comprar un producto mío. Puede ayudar a descubrir en quién confiar. Puede ayudar a averigua",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 9",
        "realExample": "r si debo meterme en una situación que estoy observando desde lejos. Puede ayudar a averiguar si mi pareja me engañó. Puede ayudar a averiguar si mi pareja me dice la verdad. Puede ayudar a averiguar cuándo es el momento adecuado para pedirle un aumento al jefe. Etc… Estas cosas son absolutamente ciertas. Saber leer el lenguaje corporal puede ayudarnos en nuestra vida diaria en nuestra relación con los demás. Es verdad. Pero no tenemos que ver esto como una calle de un solo sentido. Conocer el lenguaje corporal ayuda a relacionarnos con los demás. Comprender cómo funciona nuestro cuerpo y cómo reacciona a nuestras emociones significa que podemos controlarlo en parte. Esto no significa que tengamos que ser buenos mintiendo controlando nuestros gestos. Ciertamente, para un vendedor esto también puede ayudar a cerrar una negociación. Lo que quiero decir es mucho más ético y útil en la vida cotidiana. Un gesto nuestro siempre refuerza un estado de ánimo, un pensamiento propio. Tomemos el ejemplo de un vendedor que llama a nuestra puerta. ¿Quién de nosotros se alegra cuando nos encontramos frente a una persona que viene a ofrecernos un nuevo producto o un nuevo contrato de electricidad? Prácticamente nadie. Nuestro cuerpo envía inmediatamente señales de cierre y solo si el vendedor es realmente bueno puede comenzar su discurso. Llegando a este punto es muy probable que ya nos hayamos cruzado de brazos, como para reforzar el hecho de que, diga lo que diga, de todos modos no comprar",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 10",
        "realExample": "emos nada. Lo mismo puede suceder cuando mantenemos una animada discusión con un amigo sobre política o temas importantes. Crucemos los brazos y tomemos una posición definitiva sobre nuestra idea y nos cerremos. ¿Sabes cuántas veces te habría convenido darte cuenta de que te habías equivocado de actitud y habrías acertado al escuchar? Para ello, solo necesitas estar atento a la reacción de tu cuerpo y, en ocasiones como las que acabamos de describir, solo necesitas hacer un esfuerzo y eliminar los brazos cruzados para prepararte mejor para escuchar. La próxima vez que des una señal de cierre intenta eliminarlo y verás que comprenderás mucho más sobre ti y la función de tu lenguaje corporal, cómo también puede afectarte inconscientemente. Pero hay muchos ejemplos que podría darte de situaciones en las que harías bien en controlar tu lenguaje corporal. No siempre hacemos gestos solo cuando estamos frente a una audiencia. Piense en quién tiene una conversación telefónica. Todos hacemos gestos en el teléfono, pasándonos el teléfono de una mano a la otra en función de los gestos que tengamos que hacer, como si la persona del otro lado del teléfono pudiera vernos. En realidad, nuestro interlocutor no puede vernos, pero los que nos rodean sí pueden, controlar los propios gestos en estas situaciones nos expone menos a la posibilidad de que una tercera persona intercepte, por ejemplo, las señales que emitimos durante una conversación que deberían permanecer en privado. ¿Otro ejemplo?",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 11",
        "realExample": "Aquellos que todavía usan un mouse con cable en su computadora tienen una gran posibilidad de encontrarlo todo retorcido. Recuerdo que a menudo tenía que desenchufar el mouse para estirar el cable correctamente. Cada vez que tenemos un cable o un objeto conectado a un cable en nuestras manos, tendemos a moverlo involuntariamente en nuestras manos, tan involuntariamente que a menudo nos preguntamos \"¿Cómo se torció así?\". La consistencia: conocimientos Toda falsedad es una máscara, y no importa lo bien hecha que esté, siempre consigues, con un poco de atención, distinguirla del rostro. (Alexandre Dumas). No es posible adquirir fácilmente buenas habilidades lectoras, tanto de forma rápida como sin margen de error, en el lenguaje corporal. Hasta ahora he destacado repetidamente lo importante que es entrenar tanto nuestra capacidad para detectar las señales que está enviando un cuerpo como para desarrollar la capacidad de analizar todas las señales en una visión global que tenga en cuenta la relación entre ellas y su relación con el momento en que se revelan. Una persona puede sonreír y ser feliz. Una persona puede sonreír, pero si su risa es nerviosa, está lejos de ser feliz en la situación en la que se encuentra. Una persona puede sonreír nerviosamente durante una conversación con amigos y luego puede tener otros pensamientos en su cabeza que están fuera de la situación en la que se encuentra. Comprender la coherencia de los gestos con una situación determinada es fundamental p",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 12",
        "realExample": "ara descubrir la actitud de una persona y dar sentido a sus acciones. Al principio puede que le resulte muy fácil leer los gestos individuales, pero tenga la seguridad de que, sin poder evaluar el conjunto, una determinada señal puede amplificarse o confundirse con la exactamente opuesta. Entonces, un segundo consejo que quiero darte, antes de ser aún más específico, es que no tengas prisa y no llegues a conclusiones obvias de inmediato. Es cierto que todos estamos inclinados a querer alcanzar el máximo resultado de forma rápida y (posiblemente) con el mínimo esfuerzo, pero siempre es preferible dar los pasos adecuados para conseguir buenos resultados. Por ejemplo, es posible que desee concentrarse todos los días en una sola señal, como mirar a los ojos de las personas o la postura de todos los que pasan a su lado. Puede intentar sentarse en un banco y mirar desde la distancia a todos los que están sentados en las mesas del bar y ver si puede ver el efecto espejo mientras conversan entre ellos. Imagina que tuvieras que hacer un examen en la universidad: ¿leerías todo el libro de una vez o estudiarías capítulo tras capítulo? En este caso, el principio es el mismo. Solo cuando seas consciente de que has aprendido un cierto dominio en la identificación de los principales gestos, podrás esforzarte para evaluarlos en su conjunto para comprender mejor las señales reales que libera involuntariamente el cuerpo humano. Como ya se mencionó, habrá dos tipos de congruencias para analizar",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 13",
        "realExample": ": Congruencia gesto-gesto. Congruencia gesto-palabra. La evaluación de la congruencia entre los gestos y lo que se dice requiere mucho ejercicio, sobre todo si nos enfrentamos a una personalidad fuerte. Imagínese un político o un vendedor experto: estas personas difícilmente mostrarían inconsistencias obvias entre los gestos y las palabras, especialmente cuando están dirigiendo la acción, como podría suceder en una rueda de prensa o durante una presentación de producto. Es diferente cuando el político se ve sometido a preguntas inesperadas (no necesariamente incómodas) o cuando se le señala a un vendedor un defecto obvio en su producto. En estos casos el lenguaje corporal (que es el más veraz) se muestra con mayor claridad y un buen observador es capaz de valorar si existe congruencia entre palabras y gestos. Esta es una de las razones por las que las preguntas siempre se acuerdan durante una entrevista: esto le permite tener más control sobre sus gestos. A una pregunta inesperada, el pensamiento se centra en formar la mejor respuesta, pero esto deja al cuerpo libre para expresarse. Los gestos de los políticos se clasifican en psicología y psicoterapia como movimientos batónicos co-verbales y se caracterizan por estar estrictamente ligados al ritmo del habla y otorgan a las palabras, con movimientos del brazo y de la mano, una estructura temporal, enfatizando la fuerza de impacto del tema. Preste atención a esto la próxima vez que vea a un político hablando a la multitud. Rec",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 14",
        "realExample": "uerda: observando y tomando conciencia de los gestos, al cabo de un tiempo será bastante sencillo, pero interpretarlos será bastante diferente. De hecho, otro ejercicio que tendrás que hacer es poder evaluar a otras personas, dejando de lado tus reacciones emocionales, tus hábitos, tus gestos. La persona que observe tendrá sus propios hábitos y manías, por lo que debe intentar estudiarlos sin prejuicios. Leer personas no es un juego: una vez que hemos definido a una persona y la hemos catalogado en nuestra mente (por ejemplo, en el archivo de personas falsas), difícilmente seremos capaces de mirarla de otra manera.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m23",
    "bookNumber": 23,
    "title": "Expresiones Faciales Y Mirada",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "--- Expresiones faciales “Aprenderás por las malas que en el camino te encontrarás con millones de máscaras y muy pocas caras todos los días.” (Luigi Pirandello) A su manera esta frase se te ha repetido varias veces desde que naciste: nunca te fíes de la primera apariencia. Si bien es cierto que una expresión facial puede transmitir mucha información sobre una persona, también es cierto que la primera impresión no siempre es la correcta. Las expresiones faciales son las primeras que nos impactan cuando nos enfrentamos a una nueva persona y, precisamente por eso, si la persona es buena fingiendo, son las expresiones que más nos pueden desviar en su valoración. Hay personas a las que se les da muy bien llevar una máscara que oculta sus verdaderas intenciones, sus pensamientos. Por eso, siempre debemos estar atentos a los pequeños signos de inconsistencia que se abren paso entre los clásicos signos que nos envía una cara: por ejemplo, una sonrisa puede indicar aprobación o felicidad, un ceño fruncido puede indicar desaprobación o infelicidad. En algunos casos, nuestras expresiones faciales pueden revelar nuestros verdaderos sentimientos sobre una situación particular o dar información sobre nuestro estado de salud. Mientras nos aseguramos de que nos sentimos bien, nuestras expresiones faciales pueden decir lo contrario. Estas son las emociones que podemos transmitir con el rostro: Felicidad. Tristeza. Enfado. Sorpresa. Disgusto. Miedo. Confusión. Emoción. Deseo. Desprecio. En ge",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 2",
        "realExample": "neral, la expresión facial más confiable y amigable implicaba un leve alzamiento de cejas y una leve sonrisa. Según un estudio, esta es la expresión que emana de una persona que ha comenzado a confiar en lo que le decimos. Como formas de lenguaje corporal universal, las expresiones faciales han sido objeto de numerosas investigaciones. Algunos estudios sugieren que: Es posible emitir juicios sobre la inteligencia de una persona en función de su rostro y expresiones. Las personas que tienen una cara más estrecha y una nariz más prominente tienen más probabilidades de ser percibidas como inteligentes. Las personas con expresiones sonrientes y alegres generalmente se consideran más inteligentes que aquellas con expresiones enojadas. Saber analizar las expresiones faciales en su conjunto puede determinar la transición del fracaso al éxito. Imagina que estás intentando realizar una venta. Seguramente poder entender el momento exacto en el que es más probable que nuestro interlocutor confíe en nosotros es un extra. ¿Cuáles podrían ser algunas de las señales que nos envía un cliente potencial? Si nota que los ojos de un cliente potencial están bajados y su cara hacia afuera, tenga la seguridad de que no es un buen momento para proponer un contrato. Probablemente tomó el enfoque equivocado o no usó bien las técnicas de persuasión o no es un cliente objetivo con el producto que ofrece. Si notas que su boca está relajada, que no tiene una sonrisa mecánica, que su barbilla está hacia ad",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "elante, probablemente esté considerando tu artículo. Si sus ojos se fijan en los tuyos durante varios segundos con una ligera sonrisa, está sopesando tu propuesta. Si tu cliente empieza a seguir tus movimientos con la cabeza (efecto espejo), su sonrisa es relajada y sus ojos transmiten entusiasmo, entonces la venta está prácticamente hecha. Ojos Cuando se participa en una conversación con otra persona, tomar nota de los movimientos oculares es una parte natural e importante del proceso de comunicación. Anteriormente he mencionado la importancia de mirar. No en vano se les llama a los ojos las \"ventanas del alma\" porque son capaces de revelar mucho sobre lo que una persona siente o piensa. Aquí están las principales señales a tener en cuenta cuando observamos los ojos de nuestro interlocutor: 1. La mirada. 2. Los párpados. 3. Las pupilas. La mirada La mirada puede mostrarnos si una persona está interesada en nuestra compañía y conversación. En este caso la mirada debe estar fija en nuestros ojos o al menos mostrar que estamos prestando atención. Está bien si apartas la mirada de vez en cuando, esto aún puede indicar una situación de confianza y relajación. De hecho, una mirada demasiado larga podría ser una señal amenazante. Pero si la mirada se desvía con demasiada frecuencia, entonces nuestro interlocutor tiene pensamientos más urgentes y apremiantes que lo distraen o puede sentirse incómodo durante la conversación porque puede tener algo que ocultar. Una persona que miente,",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 4",
        "realExample": "si no está bien preparada, es incapaz de soportar la mirada de la otra persona. Los párpados Todos parpadeamos. Este es un movimiento natural que nos ayuda a limpiar y humedecer constantemente los ojos. Pero la frecuencia con la que cerramos y abrimos los ojos puede darnos algunas señales: Si las personas parpadean más rápido, definitivamente se sienten angustiadas o incómodas. Sin embargo, parpadear ocasionalmente puede indicar que una persona está tratando intencionalmente de controlar los movimientos de sus ojos. Por ejemplo, un jugador de póquer puede parpadear con menos frecuencia porque intenta intencionalmente parecer no emocionado. Las pupilas Uno de los signos más sutiles de la comunicación no verbal es el tamaño de la pupila. Al igual que los párpados, este está sujeto a movimientos naturales a medida que aumenta o disminuye de diámetro según las condiciones de luz. Pero la pupila también puede variar ligeramente de tamaño según las emociones y, a menudo, una pupila dilatada se asocia con la presunta disponibilidad sexual de una persona hacia otra, o en cualquier caso, una pupila dilatada sin intervención de luz generalmente muestra interés. La boca y los labios Las expresiones y los movimientos de la boca también pueden ser esenciales en la lectura del lenguaje corporal. Hay diferentes músculos que corren para modificar las expresiones de nuestra boca pero sin duda el factor más visible, el que se destaca de inmediato en los ojos, es el aporte que dan los labios.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "Por ejemplo, masticar el labio inferior puede indicar que la persona está experimentando sentimientos de preocupación, miedo o inseguridad. Cubrirse la boca puede ser un signo de buenos modales al bostezar o toser, pero también puede ser un intento de tapar un ceño fruncido de desaprobación. Una sonrisa es quizás uno de los mayores signos del lenguaje corporal, pero una sonrisa también se puede interpretar de muchas maneras. Una sonrisa puede ser genuina o puede usarse para expresar falsa felicidad, sarcasmo o incluso cinismo. Al evaluar el lenguaje corporal, se debe prestar atención a las siguientes señales, tanto de la boca como de los labios: Labios apretados: apretar los labios puede ser un indicador de disgusto, desaprobación o desconfianza. Morderse los labios: las personas a veces se muerden los labios cuando están preocupadas, ansiosas o estresadas. Cubrirse la boca: cuando las personas quieren ocultar una reacción emocional, pueden taparse la boca para evitar mostrar sonrisas o expresiones de asombro / miedo. Subir o bajar los lados de la boca: estos suelen ser cambios leves, pero son indicadores importantes de lo que siente una persona. Cuando están ligeramente elevados, puede significar que la persona se siente feliz u optimista. Por otro lado, si está boca abajo puede ser un indicador de tristeza, desaprobación o incluso una mueca.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m24",
    "bookNumber": 24,
    "title": "Brazos Piernas Postura Y Proxemia",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "Brazos y piernas Por lo general, cuando hablamos, estamos ocupados procesando nuestros pensamientos y las pocas veces que buscamos la retroalimentación de nuestro interlocutor lo hacemos directamente (verbalmente, preguntando) o más raramente indirectamente. En este último caso, en casi todos los casos, nuestra atención se centra en las expresiones faciales. De hecho, los brazos y las piernas también pueden ser útiles para transmitir información no verbal. El cruce de brazos puede indicar que la persona se ha puesto a la defensiva. Una persona que cruza las piernas y observa a otra desde la distancia puede indicar disgusto o malestar hacia esa persona. Extender el pecho y empujar los brazos hacia afuera puede ser un intento de parecer más grande o más imponente, mientras que, por otro lado, mantener los brazos cerca del cuerpo puede ser un esfuerzo para minimizarse o para tratar de salir del campo de atención. Entonces, veamos a qué señales debemos prestar atención: Los brazos cruzados pueden indicar una persona que está a la defensiva, se protege a sí misma o se cierra. Ciertamente, lejos de ser receptivo, una persona con tal actitud requiere mucho trabajo para abrirse. Pararse con las manos en las caderas puede indicar una persona segura, pero en algunos casos también puede ser un signo de agresión. ¿Ha visto la actitud clásica de una persona que pone las manos detrás de la espalda y las aprieta? Mantener las manos detrás de la espalda indica que la persona se siente aburri",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 2",
        "realExample": "da, ansiosa o incluso una señal de que está enojada. Tocarse los dedos rápidamente y estar inquieto puede ser una señal de que una persona está impaciente o frustrada. Si los movimientos son más lentos, la persona se aburre. Las piernas cruzadas pueden indicar que una persona se siente incómoda, se siente cerrada o necesita privacidad. Sin embargo, este es un gesto que puede malinterpretarse fácilmente, ya que a veces las piernas se cruzan por costumbre y por necesidad (una mujer con una falda demasiado corta). Si una persona cruza las piernas inmediatamente después de sentarse, este gesto también puede ser un hábito (no confundir con comodidad). Por el contrario, si el gesto se realiza durante el transcurso de una conversación, acompañado de otros signos de insatisfacción, entonces ciertamente es un gesto de cierre. PD. Diferencia entre un gesto habitual y un gesto de comodidad: una persona que a menudo tiene un carácter incómodo puede haber adquirido el hábito de cruzar las piernas y lo hace incluso en situaciones en las que no es necesario. Sin embargo, cruzar las piernas ciertamente no es un gesto cómodo y así lo demuestra el hecho de que después de cierto tiempo nos vemos obligados a cambiar de posición. Veamos a qué movimientos de brazos, manos y piernas debemos prestar atención: Sube la manga: su función es lucir tus músculos como una amenaza para usarlos o como una invitación a actuar. Manos en las caderas y piernas separadas: las piernas firmemente plantadas en el su",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "elo denotan confianza y las manos en las caderas añaden una sensación de desafío. Sostener la mano en las caderas y extender el otro brazo hacia la otra persona es un signo directo de agresión ya que el brazo extendido hacia la otra persona invade su espacio. Es una señal de desafío muy fuerte. Piernas separadas y manos detrás de la espalda: la persona se encuentra en estado de alerta apoyado en una agresión controlada y seguridad por sus propios medios. Frotarse nerviosamente los dedos o las manos, frotar un pie con el otro, mover el cuello de la camisa con los dedos, pellizcarse las mejillas o cualquier otra parte del cuerpo donde la piel esté blanda: todos estos son signos que indican un estado de ansiedad y malestar. Pueden ir acompañadas de un aumento repentino de la sudoración. Frotar la zona del desgarro: este es un signo de sufrimiento. En este caso el lenguaje corporal intenta hacernos entender que el sujeto es moral o psicológicamente doloroso. Protección de los órganos genitales: este gesto indica que el sujeto se siente inconscientemente amenazado por algo de lo que quiere defenderse. Agarrar el tobillo y mover nerviosamente el pie: este gesto indica un estado de agresividad reprimida y muestra que hay voluntad de actuar o de alguna manera pasar a la acción. Mano en la boca o mano en la oreja: son gestos que expresan la posibilidad de poder decir más pero con la voluntad de no hablar más o de no escuchar más. Apoyarse en un objeto o sujetarlo con firmeza: es un ge",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 4",
        "realExample": "sto de derechos territoriales, indica que ese objeto es propiedad de la persona. Inclinarse hacia atrás con las manos entrelazadas detrás de la cabeza es un gesto de superioridad. Tobillos cruzados Las personas que tienen fuertes sentimientos y grandes emociones asumen la posición de tobillos cruzados. Esto sucede, por ejemplo, en situaciones desagradables como un examen dental o cuando está tenso durante una entrevista de trabajo. Por lo general, este gesto va acompañado de un apretón de manos. Cruzar los tobillos es un signo obvio de tensión porque no es natural. Postura La postura no es solo la posición que asume nuestro cuerpo en una situación determinada. Analizar la postura de un individuo también significa examinar físicamente el cuerpo de una persona, incluida la forma física general de un individuo. Observar la postura de un individuo en su totalidad puede darnos mucha información sobre cómo se siente esta persona, pero también sugerencias sobre las características de la personalidad. Puedes entender si estás mirando a una persona segura de sí misma, o si es abierta o sumisa. Si miras a una persona sentada erguida, por ejemplo, puede indicar que está concentrada y prestando atención a lo que está sucediendo. No solo están interesados, sino que intentan captar todo lo que se propone u observa. Una persona sentada con el cuerpo inclinado hacia adelante puede implicar que está aburrida o que la situación la deja indiferente a lo que está sucediendo. Entonces veamos las",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "principales señales a observar: La postura abierta implica mantener el tronco del cuerpo abierto y expuesto. Este tipo de postura indica amabilidad, sinceridad y amabilidad, pero también cierta confianza en la capacidad de evaluar. La persona escucha y, al mismo tiempo, es consciente de su capacidad para recibir información correctamente. La postura cerrada (curva) consiste en ocultar el tronco del cuerpo, a menudo inclinándose hacia adelante y manteniendo los brazos y / o piernas cruzados. Este tipo de postura puede indicar dos tipos de personalidad. La mayoría de las veces puede ser un indicador de hostilidad, cierre, falta de simpatía y ansiedad. Pero también puede mostrar inseguridad: en este caso, la persona puede necesitar más tiempo para reflexionar. Él o ella no confía en sus instintos probablemente debido a malas decisiones en el pasado. La postura de cara al interlocutor indica una gran apertura y disposición. Indica el momento en que la persona ha ganado confianza en nosotros y está decidida a escuchar nuestros consejos. Por el contrario, una postura que tiende a alejar el cuerpo muestra una extrema falta de confianza. Si esta postura se da al inicio de la reunión entonces nos encontramos ante una persona prejuiciada por naturaleza pero que aún puede estar convencida de la bondad de nuestra propuesta. Si, por el contrario, esto ocurre durante la reunión, es necesario comprender de inmediato qué desencadenó esta reacción si aún queremos tener alguna posibilidad de l",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "legar a un acuerdo. Proxemía Es la disciplina semiológica que estudia los gestos, el comportamiento, el espacio y las distancias dentro de una comunicación, tanto verbal como no verbal, y es una de las varias subcategorías en el estudio de la comunicación no verbal, incluyendo háptica (tacto), kinésica (movimiento corporal), vocalidad (paralingualismo) y cromémica (estructura temporal). ¿Alguna vez has tenido que lidiar con una persona tan insistente que las sientes físicamente en ti? El término fue acuñado por el antropólogo estadounidense Edward Twitchell Hall y se refiere a la distancia que se crea entre las personas mientras interactúan. Este elemento puede resultarle muy útil a la hora de evaluar a distancia la relación entre dos personas que interactúan entre sí, especialmente si son libres de moverse. La situación ideal es cuando interactúan de pie. En su estudio, Edward T. Hall definió cuatro niveles de distancia social que ocurren en diferentes situaciones: Distancia íntima. Distancia personal. Distancia social. Distancia pública. Distancia íntima Una distancia de 15 a 45 centímetros se define como \"distancia íntima\" e indica una relación de gran comodidad entre los individuos. Suele ocurrir con contacto íntimo como abrazar, susurrar o tocar. Distancia Personal Una distancia de 45 a 120 centímetros se define como \"distancia personal\" y generalmente ocurre entre personas que son familiares o amigos cercanos. Si durante la interacción las personas están paradas y libre",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 7",
        "realExample": "s para moverse, el espacio entre ellas determina el nivel de su intimidad. Distancia social Una distancia de 120 a 360 centímetros se llama \"distancia social\" y se usa a menudo entre personas que son conocidas, con las que uno tiene buenas relaciones pero que no se conocen lo suficientemente bien. Además, en este caso el nivel de conocimiento está determinado por la distancia entre las dos personas. Distancia pública Una distancia de 360 centímetros a 10 metros se llama \"distancia pública\" y se usa a menudo en situaciones en las que tienes que hablar en público. Sin embargo, las distancias pueden variar durante una conversación. Acercarse a otra persona es visto como un gesto de aceptación por parte del individuo que cierra la brecha, acercarse físicamente a ella muestra un interés común por compartir con confianza. Esto también puede suceder durante una conversación entre dos personas que no se conocen. Imagine una oferta de trabajo, una que generalmente no se ve favorablemente como ganancias rápidas y fáciles. Inicialmente, tiende a mantener una cierta distancia para mostrar su escepticismo también. Sin embargo, cuando una persona se entusiasma mucho con la propuesta, se acerca más y más a medida que aumenta su entusiasmo. Visto desde fuera, el gesto de una persona acercándose a la otra durante una conversación también se puede interpretar como un deseo de hacer entender a los demás presentes que la conversación es cerrada y no abierta a todos. Si, por el contrario, intenta",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "s acercarte a una pareja que está hablando y tienden a alejarse, la señal indica que la conversación está abierta. En estos casos, es fácil llegar a una posición circular en la que varias personas participan en la misma discusión.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m25",
    "bookNumber": 25,
    "title": "Movimientos Tensionales Actitudes Y Conclusion",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "--- Movimientos que indican liberación tensional Veamos cuáles son algunos de los gestos habituales que nos pueden ayudar a definir el estado de ánimo de una persona. Perplejidad Una persona está perpleja: Si levanta las cejas. Si usa sus dedos para levantar las cejas... Si comienza a rascarse en el centro de la frente. Si empuja la piel de su frente hacia arriba con los dedos. Esto significa que esa persona no está convencida de lo que está diciendo y, por lo tanto, necesita más explicaciones. La próxima vez que se encuentre en tal situación, notará fácilmente la aparición de un ligero picor en el centro de la frente, que es la señal que el cuerpo le envía cuando está desconcertado. Desacuerdo Una persona en desacuerdo no puede quedarse quieta para escuchar y generalmente hace algunos gestos reconocibles: Empieza a buscar el pelo de su camisa y sacudirla... Empieza a desempolvar su ropa. Si las usa, levanta sus gafas y a menudo las limpia (como para significar que quiere ver mejor). Son signos claros de que la persona no solo está perpleja sino que incluso tiene un punto de vista contrario al de su interlocutor. Si, por el contrario, estás sentado en una mesa y la persona empieza a quitar polvo o migas de la mesa (independientemente de que estén ahí o no) entonces estás en una posición de claro rechazo. Intolerancia o rechazo agresivo Una persona se muestra intolerante cuando empuja un objeto, combinando este movimiento con una expresión de desprecio en el rostro. La expresi",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 2",
        "realExample": "ón facial es importante para no confundir este gesto con asombro o timidez. Si, por el contrario, el objeto es empujado en dirección al interlocutor, entonces es una señal de rechazo muy agresiva la que determina el cierre definitivo. Enfado Por lo general, una persona muestra su enojo cuando tiene algún objeto en sus manos o, en ausencia de un objeto, está apretando los puños. Actitudes comunes En esta sección vemos algunas actitudes muy comunes que son fáciles de notar e interpretar. Empujar la barbilla hacia adelante: este es un gesto que pertenece a la categoría de signos de desafío e invitación a la acción. La persona tiene tanta confianza que muestra descaradamente una parte vulnerable de su rostro. Además de una gran confianza en los propios medios, también denota una baja consideración del oponente. Entrecerrar los ojos: si no hay condiciones de iluminación particulares que justifiquen este gesto, los ojos entornados durante una conversación son una expresión de desafío, desprecio o escepticismo. Señalar con el dedo índice a la persona con la que estás hablando: es un signo de competencia y, aunque esté dirigido a una persona en concreto, puede indicar todo el grupo de personas que está representado por esa persona. Por ejemplo, señalar a un periodista durante una conferencia de prensa puede indicar a todos los periodistas o a todos los periodistas que trabajan en el mismo periódico. Romper un trozo de papel o romper el capuchón de un bolígrafo o algo así: es un compo",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 3",
        "realExample": "rtamiento que revela un impulso destructivo inconsciente. El gesto manifiesta simbólicamente una voluntad de demoler a través del papel, a nosotros mismos o lo que estamos expresando. Mordisquearse las uñas: es un deseo inconsciente de negación. Golpear un diente con la uña y hacer ruido: es una señal contraria a la anterior y representa el despliegue de los propios medios de agresión. Rechinar los dientes es un gesto muy común en el mundo animal. Aclare su garganta o haga toses rápidas y secas: estas son señales paralingüísticas (vocales) y sirven para aliviar la tensión. Empujar la lengua dentro de la mejilla: es una señal que representa rechazo o molestia. Gestos de derechos territoriales Desmond Morris, zoólogo y divulgador científico británico, que examinó la teoría de los derechos territoriales expresados por animales y humanos, se le atribuye el análisis de los gestos del derecho territorial. En este sentido, recomiendo leer su libro The Naked Monkey: Estudio zoológico del animal humano. Explica que los machos, cuando proclaman derechos territoriales, orinan o defecan, marcando sus fronteras con sus olores. Evidentemente, el ser humano se comporta de otra manera, pero también utiliza gestos para dejar claro, incluso inconscientemente, cuál es su territorio. Cada vez que ponemos un pie en un objeto, estamos reclamando la propiedad. ¿Pondrías tu pie en el parachoques del auto de tu amigo? No. Pero si es tu auto, el gesto también es algo natural para descargar algo de pes",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 4",
        "realExample": "o. Lo haces porque es tu coche e inconscientemente estás reclamando la propiedad (puedo hacerlo porque el coche es mío). O cuando ves que tu pareja están molestos o simplemente están charlando con otra persona... ¿qué haces? Te acercas y te involucras en la conversación, pero no antes de poner tu brazo alrededor de la mitad del cuello. Una vez más, está reclamando su propia propiedad. ¿Quién pone los pies en el escritorio sino el director de la oficina? La oficina es mía y lo demostraré poniendo mis pies donde tú no puedas. A veces ampliamos nuestros derechos territoriales a lo que el psiquiatra británico Humphry Osmond llamó \"espacio socio-refugiado\". En la práctica distribuimos nuestros objetos personales fácilmente reconocibles con la esperanza de que nadie invada nuestro espacio. ¿Nunca has hecho eso? Imagina que te invitan a una cena con mucha gente. No hay asientos reservados en la mesa por lo que la gente comienza a colocar varios objetos sobre las sillas (abrigos, bolsos, etc.) para poder ocupar los asientos. Los estudiantes de las grandes aulas universitarias distribuyen sus libros en los pupitres para ocuparlos. ¿Alguna vez has notado cómo en un ascensor las personas intentan alejarse lo más posible unas de otras ocupando espacios específicos, generalmente las cuatro esquinas? Humphry Osmond acuñó los términos \"sociopétalo\" y \"sociofugal\" para describir la ocupación de lugares que fomentan o desalientan la interacción social. Gestos que indican nerviosismo y/o estad",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 5",
        "realExample": "os de ansiedad. Ya hemos visto cómo el carraspeo es un gesto útil para aliviar tensiones y presupone nerviosismo o ansiedad. Esto sucede debido al moco que se forma en la garganta, una reacción natural como ocurre, por ejemplo, con la sudoración. Para las personas muy nerviosas este gesto puede incluso convertirse en un hábito y realizarse de forma continua incluso sin una necesidad física real. Las personas que más aprovechan este gesto son los varones adultos. Veamos otros. Silbido: es un gesto que puede indicar diferentes estados de ánimo pero que se suele utilizar para exorcizar un estado de ansiedad. Columpiarse en la silla: es un gesto de nerviosismo que indica que una persona está pensando demasiado y que sus pensamientos le traen ansiedad. Subirse los pantalones: es un gesto que se suele hacer cuando uno está sentado e indica que una persona está tomando una decisión importante. El gesto termina en cuanto se toma la decisión. Es un gesto revelador que es muy útil para quienes, por ejemplo, están tratando de hacer una venta porque entienden que la persona aún ha optado por considerar comprar, pero aún muestran que están nerviosos y aún no están seguros de su elección. Rebuscar en los bolsillos: es un gesto de nerviosismo que suele ser gratificante si encontramos algo dentro de los bolsillos que hace ruido, como dinero o un manojo de llaves. Especialmente hurgar el dinero en el bolsillo hace pensar en una persona con problemas económicos o preocupaciones económicas. Toc",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "ar con frecuencia el lóbulo de la oreja es un gesto que oculta la ansiedad si se repite con el tiempo. En cambio, un toque rápido podría ser un gesto de interrupción que veremos en el próximo capítulo. Rascarse la cabeza o frotarse la nuca con frustración: este es un gesto que muestra a una persona enojada y nerviosa porque no es capaz de expresar sus sentimientos directamente. Gestos de interrupción Se trata de gestos importantes que deben ser reconocidos especialmente por todos aquellos que están inmersos en una conversación de confrontación, es decir, cuando no hay tiempos de conversación fijos pero cuando es posible intervenir en el discurso en cualquier momento. Entonces esto sucede durante una conversación con un amigo pero también durante una presentación para la venta de un producto. Repetidamente he señalado en el libro \"Persuasión, principios y técnicas\" lo importante que es escuchar a la otra persona para poder preparar sus contraataques. Por tanto, escuchar es importante, pero siempre es muy difícil dejar la palabra a los demás. Cuando estamos inmersos en una conversación, ninguno de nosotros quiere abandonar su posición de orador. Ceder el paso a los demás es perder la posición dominante e inconscientemente tendemos a mantener el control de la palabra. Pero todos, cuando nos encontramos del otro lado, es decir, del lado del oyente, solo somos capaces de mantener nuestra posición de silencio y escucha por un corto tiempo si tenemos la oportunidad de intervenir act",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 7",
        "realExample": "ivamente en el discurso. Es necesario para poder entender que debemos dar el derecho de palabra y dejar hablar a nuestro interlocutor. Para ello es bueno saber reconocer los gestos de interrupción, es decir, aquellos gestos que hacemos, muchas veces de forma inconsciente, para advertir a la otra persona de que queremos hablar. La mayoría de ellos derivan de un gesto ancestral que todos aprendimos en nuestra experiencia escolar: la mano levantada. Si tienes que ir al baño, levanta la mano y pide permiso, si quieres hablar o responder la pregunta, levanta la mano y espera a que te llamen. A menudo, durante un discurso, la persona que quiere hablar inconscientemente levanta la mano y solo cuando está bien levantada, nota el gesto que está haciendo. Entonces, ¿qué debería hacer? ¿Continuar levantando la mano como lo hizo en la escuela? Claro que no. Luego, la mano suele terminar su recorrido hacia el lóbulo de la oreja o hacia los labios, como para reprimir la propia voz. Luego, la mano vuelve a su lugar. Aquellos que reprimen estos gestos de interrupción generalmente solo mueven la mano hacia arriba unos centímetros y luego la dejan caer hacia atrás. Los gestos de interrupción se pueden repetir varias veces sin que se pronuncie una sola palabra. Reconocer un gesto de interrupción es importante por varias razones: por un lado, el oyente te confirma inconscientemente que está interesado en el discurso, que lo está siguiendo de cerca y que tiene su propia opinión. Por otro lado, le",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 8",
        "realExample": "dará la oportunidad de hablar y ganar una gran confianza de su parte para la continuación de la conversación. Gestos de aburrimiento Ofrezca lápiz y papel a alguien que esté escuchando. Si comienza a garabatear, puede estar seguro de que está aburrido. En algunos casos, puede notar fácilmente esta situación, por ejemplo, un maestro puede ver a un alumno garabateando en el escritorio durante el horario de clase. Pero, por supuesto, no siempre puedes darle lápiz y papel a la persona que tienes delante. Otro indicador de aburrimiento es la mirada vacía, la mirada que te hace darte cuenta de que una persona está completamente ausente y pérdida en sus pensamientos, que está dormida con los ojos abiertos. Esta mirada es reconocible por el hecho de que las pupilas están fijas y no insinúan movimientos y además los párpados parpadean mucho menos de lo habitual, como si estuvieran en trance. Ambos gestos son muy comunes entre los estudiantes que \"se quedan dormidos\" durante las lecciones escolares. En consecuencia, son señales que los docentes deben reconocer tanto para llamar la atención como para cambiar su estilo de comunicación si esto ocurre con demasiada frecuencia. Gestos de expectativa Una persona que tiene una expectativa puede demostrar esto de varias maneras: Se frota las manos (con el mismo movimiento que suele hacer cuando se lava las manos). Frote las palmas de las manos contra un pañuelo (si las palmas están mojadas, el aumento de la sudoración es una indicación de ner",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 9",
        "realExample": "viosismo asociado con la expectativa). Los hombres suelen frotarse las palmas de las manos contra los pantalones a la altura de los muslos. Cruzar los dedos (dedo medio sobre dedo índice). Los dedos cruzados son un gesto supersticioso que generalmente indica la esperanza de que algo vaya bien. Pero en algunos casos pueden indicar una unión sentimental entre dos personas. Curiosidad por los gestos más obvios y habituales Son muchos los gestos que podemos hacer con nuestras manos que son más familiares pero hay que tener cuidado con el contexto y cómo se realizan. Un puño cerrado puede indicar enojo en algunas situaciones o solidaridad en otras. Los pulgares hacia arriba y hacia abajo se utilizan a menudo como gestos de aprobación y desaprobación. El gesto OK, que se hace al tocar el pulgar y el índice juntos en un círculo y extender los otros tres dedos, se puede usar para indicar que todo está bien. En algunos países de América del Sur, el símbolo es en realidad un gesto vulgar. El signo de la victoria, creado al levantar los dedos índice y medio y separarlos para crear una forma de V, significa paz o victoria en algunos países. En el Reino Unido y Australia, el símbolo adquiere un significado ofensivo cuando el dorso de la mano mira hacia afuera. Conclusión La clave de todo es observar y practicar, observar las señales que salen del cuerpo y relacionarlas con la situación en la que te encuentras. Evalúe si están de acuerdo o en desacuerdo. Si están de acuerdo, es decir, si s",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 10",
        "realExample": "on inherentes a la discusión que se está produciendo, entonces podemos utilizarlos para comprender los sentimientos, emociones, intenciones reales de nuestro interlocutor. Evaluar si están interesados o desinteresados, aburridos o felices de escucharnos, listos para completar una compra o si necesitan más tiempo para convencerse, evaluar si hay márgenes en una negociación o incluso entender a quién acudir dentro de un grupo de personas (que tiene el control del grupo). Si, por otro lado, las señales son discordantes con la situación que está experimentando, entonces existe una discrepancia entre lo que dice la persona y lo que comunica su propio lenguaje corporal. En este caso, ya sea un signo de malestar (el interlocutor está pensando en algo negativo) o un signo de confort (el interlocutor está pensando en un hecho positivo), la persona con la que se está conversando no está interesada en el tema. Por tanto, hay que aprender a unir todo, los diversos gestos y relacionarlos con la situación. Nunca puedes leer los pensamientos exactos de una persona, pero puedes aprender mucho de su lenguaje corporal, y esto es particularmente cierto cuando las palabras y el lenguaje corporal no coinciden. CÓMO ANALIZAR A LAS PERSONAS Copyright ©2020 - Hayden J. Power © Copyright 2019 – Todos los derechos reservados. El contenido en este libro no puede reproducirse, duplicarse o transmitirse sin el permiso directo por escrito del autor o el editor. Bajo ninguna circunstancia se responsabiliza",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 11",
        "realExample": "rá legalmente al editor ni al autor de ningún daño, reparación o pérdida monetaria debido a la información contenida en este libro. Ya sea directa o indirectamente. Aviso Legal: Este libro está protegido por derechos de autor. Este libro es solo para uso personal. No puede modificar, distribuir, vender, usar, citar o parafrasear ninguna parte o el contenido de este libro sin el consentimiento del autor o editor. Aviso de exención de responsabilidad: Tenga en cuenta que la información contenida en este documento es solo para fines educativos y de entretenimiento. Se han realizado todos los esfuerzos para presentar información completa, precisa, actualizada y confiable. No se declaran ni implican garantías de ningún tipo. Los lectores reconocen que el autor no participa en la prestación de asesoramiento legal, financiero, médico o profesional. El contenido de este libro se ha derivado de varias fuentes. Consulte a un profesional con licencia antes de intentar cualquier técnica descrita en este libro. Al leer este documento, el lector acepta que bajo ninguna circunstancia el autor es responsable de las pérdidas, directas o indirectas, que se incurran como resultado del uso de la información contenida en este documento, incluidos, entre otros, errores, omisiones o inexactitudes.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
