const LIBROS_DATA = {
  modules: [
  {
    ...
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "Psicología maquiavélica Teoría y técnicas de psicología oscura, manipulación e influencia Giovanni Barone Galatea Ediciones Psicología maquiavélica. Teoría y técnicas de psicología oscura, manipulación e influencia, por Giovanni Barone. © Giovanni Barone 2021 © Galatea Ediciones 2021 © Todos los derechos reservados. Este documento está orientado a proporcionar información exacta y confiable respecto al tema en cuestión. La publicación es vendida con la idea de que el editor no está obligado a prestar servicios calificados, oficialmente permitidos o rendir cuentas de otra manera. Si algún asesoramiento es necesario, ya sea legal o profesional, debe ser ordenado a una persona con experiencia en la profesión. Gracias por descargar este libro electrónico. El copyright es propiedad exclusiva del autor. De ninguna manera es legal reproducir, duplicar, o transmitir cualquier parte de este documento, ya sea por medios electrónicos o en formato impreso con fines comerciales o sin ánimos de lucro. La grabación de esta publicación está estrictamente prohibida y cualquier almacenamiento de este documento no está permitido a menos que tenga el permiso por escrito del editor. Me ayudan mucho las calificaciones en Amazon. Si encuentras placentera la lectura de este libro, escribe tu opinión sincera acerca de él aquí. Los comentarios me ayudan a mejorar y las buenas calificaciones contribuyen a incrementar las ventas del libro, algo que me permite dedicarle un poco más de tiempo a la escritu",
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 6",
        "realExample": "ogra un liderazgo o influencia sobre los otros, es necesario estar atento a cómo se va desarrollando la relación con uno. Si esta persona manipula a otros, es de esperar que en algún momento intente ejercer su influencia sobre nosotros. Creer que a nosotros no nos va a tratar de manipular es la puerta de entrada a la manipulación. Cuanto más inofensiva parezca ante los ojos de los demás, más peligrosa se vuelve su influencia. Estar atento para no dejarse manipular y no salir lastimado de este tipo de relaciones será la forma de protegerse tanto a uno mismo como a los seres queridos que también pueden ser víctimas de estas situaciones. ---",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 13",
        "realExample": "sonal, el carisma, la imagen que despliega, etc. Otros condicionamientos que se presentan en la vida cotidiana y que impiden hacer un abordaje correcto en la toma de decisiones, tiene que ver con los múltiples factores que actúan como distractores y que nublan la capacidad de razonamiento como la cantidad de información a la que se puede acceder gracias a internet. Esto es algo que abruma y, a veces, anula la capacidad de decisión. A esto se le debe sumar la cantidad de dispositivos móviles que se han vuelto indispensables para la vida, o así nos lo hicieron creer, cada uno con sus respectivas alertas de mensajes que no se pueden dejar de contestar para no quedar desconectado del mundo virtual. Los comunicadores saben que las asociaciones automáticas y socialmente aprobadas dan resultado y que hay muy pocas posibilidades de que la audiencia refute sus productos en debates conscientes. Otros ejemplos sobre este tipo de tácticas pueden ser: ● Si se busca que compren un vino irlandés, poner como música de fondo una melodía que sea característica de dicho país. ● Si se busca que adquieran un producto caro, pueden subir los precios y decir que son exclusivos. ● Si se busca que prueben un nuevo producto, se les puede preguntar si les gusta la aventura. ● Si se busca que se sientan cómodos, se les puede ofrecer una bebida caliente. ● Si se busca que trabajen por sus objetivos, se les puede mostrar una foto de un corredor que gana una medalla. En este tipo de artimañas hay que tener",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 18",
        "realExample": "isiones. Por tanto, ofrecerán sus soluciones tratando de que la persona no piense demasiado. Por otra parte, la persona que recibe las soluciones, sentirá que el que ejerce la influencia tiene razón en sus apreciaciones y las pondrá en juego temiendo perder un trato si así no lo hace. Es importante entender que el ser humano quiere elaborar, mostrar y proteger la visión que tiene de sí mismo y del lugar que ocupa en el mundo y de la sociedad en la que se desenvuelve. Necesita elaborar su autoestima, sus creencias, darlas a conocer, alinearlas con el resto de las personas y mantenerlas a través del tiempo mientras las considere válidas. Todas las personas, sin excepción, buscan tener precisión en sus conceptos y lograr el consenso entre sus ideas y las ideas de los demás, obteniendo de esta manera la afiliación con ellos. El lenguaje que se utilizará para lograr la alineación de conceptos se adaptará a las características del receptor o de los receptores. De la misma manera, el mensaje también se estructurará considerando a quién va dirigido. Elaborar el mensaje de modo persuasivo requiere de reglas muy bien estudiadas.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 10",
        "realExample": "s se les intenta hacer entender las razones de todas las cosas. De esta manera, se genera un patrón de identidad y, como corolario, se le da pertenencia a un grupo selecto que puede ser deseado por ella. Se conjugan dos técnicas: por un lado la necesidad de identidad y, por el otro, la necesidad de afiliación. Una variante de esta técnica se basa en la utilización de un esquema de palabras. Por ejemplo: “Mente abierta”. Si se pregunta a un grupo de personas quién tiene la mente abierta, es casi seguro que el noventa por ciento de las personas indicarán que la tienen. De esta forma, se garantiza que se contará con la mayoría de las personas en favor de la idea expuesta porque de no ser así serían de mentes cerradas. Algunos ejemplos que se plantean como desafíos son los siguientes: ● ¿Qué tan abierta tienes tu mente como para poner a prueba la siguiente alternativa? ● ¿Qué tan abierta tienes tu mente como para dar una oportunidad a lo que te estoy diciendo? ● ¿Qué tan abierta tienes tu mente para poner en práctica este método y aumentar tus ingresos mensuales? ● ¿Qué tan abierta tienes tu mente para permitir que trabajemos juntos? Si se plantean las opciones de esta manera es muy probable que la otra persona acepte la idea que estás exponiendo. Es otra manera de referenciar la identidad de una persona. Esta técnica sienta una base de consenso de forma rápida y eficaz. En esta base, luego se podrán apoyar los mensajes posteriores que serán de carácter persuasivo. Es una técnica",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 12",
        "realExample": "encia, inmediatamente, se imaginará la niebla ocultando al halcón, el árbol y el molino. En las frases siguientes, las representaciones incitan son un poco más complejas: ● Entender esta idea es fácil. ● Entender esta idea no es difícil. Ambas frases significan lo mismo, pero en la mente del que escucha se despliegan representaciones variadas y abstractas. Al iniciar un discurso con palabras como: imagina que…; piensa sobre…; supongamos que…; etc., se está dando a la mente una orden para que utilice su imaginación en la dirección en que la vamos a encaminar. Este proceso es mucho más sencillo si a la audiencia se les habla de sus temas preferidos, ya que las representaciones mentales estarán más dispuestas a salir. Cuando no se conocen las preferencias del público, se puede iniciar con la palabra: “Imagina…”. Desencadena los procesos de visualización y permite que la audiencia evoque hacia sus preferencias y, de esta manera, se las conocerá. La forma más descriptiva de entender esto, es prestar atención a lo que sucede cuando se lee un libro. Las páginas escritas se vuelven imágenes en la mente del lector. El cine o la televisión coartan esa posibilidad de dejar volar la imaginación porque las imágenes ya están allí. Un comunicador hábil sabe que la clave del éxito es personalizar y humanizar los mensajes para que provoquen en los oyentes, además de las representaciones mentales, las emociones que se conectan en profundidad con el mensaje. La audiencia, probablemente, olvidar",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 6",
        "realExample": "ra comprobar que este efecto no era un caso puntual sino que podía aplicarse en diferentes situaciones obteniendo el éxito esperado, se probó esta técnica en catorce investigaciones posteriores que involucraron a cientos de participantes. Estos estudios fueron realizados por Carpenter & Boster, en el año 2009. En todos ellos los resultados obtenidos fueron sorprendentes por la eficacia de esta simple técnica en la que, siempre evaluando por comparación, se aumentaron las ventas, se logró que las personas completaran encuestas y hasta consiguieron que las personas cambiaran de actitud. Es más, esta técnica DTR ha sido efectiva en aquellas situaciones de ventas en las que las personas habitualmente suelen desconfiar de las artimañas del vendedor. Es muy importante conocer esta estrategia, aunque aplicarla o no será el resultado de un planteo moral por parte de los que utilizan las técnicas de persuasión en su accionar cotidiano. Si te encuentras en una situación en la que estás por comprar algo o vienen a solicitarte una suscripción, es importante que estés preparado para que no te engañen con esta técnica. Considera la posibilidad que la otra persona puede tratar de hacerlo, por tanto, tómate el tiempo que necesites para que tu pensamiento esté crítico en todo momento. No te dejes avasallar con el apuro que puedan mostrar estas personas porque ellas son hábiles para la aplicación de este tipo de técnicas y cuando ven que la persona duda, tienen a la mano otra artimaña novedosa",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 9",
        "realExample": "ión laboral. En todo momento, debes tener presente además de lo expuesto, los sentimientos del grupo o los individuos a los que te diriges. La mayoría toman sus decisiones basándose en lo que sienten más que en lo que razonan. Si cuando das una sugerencia incluyes una evocación a sus sentimientos, será mucho más efectiva. Estarás creando un escenario hipotético que la completa. En él quedarán plasmados los sentimientos que tendrá si decide seguirla. Hacer sugerencias o dar consejos y que los demás los acepten puede ser de mucho beneficio no solamente para la persona que lo hace sino para quien lo recibe también. Presentarla considerando los sentimientos pondrá un plus en dicha sugerencia. Si, además, eres hábil para que la otra persona no se sienta presionada y entienda que es libre de tomar la decisión que quiere, la efectividad se multiplicará. Quisiera decirte que me ayudan mucho las calificaciones en Amazon. Si estás encontrando placentera la lectura de este libro, califícalo y escribe tu opinión sincera acerca de él en Amazon aquí. Las buenas calificaciones contribuyen a incrementar las ventas del libro, algo que me permite dedicarle un poco más de tiempo a la escritura. ¡Gracias, espero que lo hayas disfrutado! - Giovani Barone. EL PATRÓN DE: “ESTOY DE ACUERDO Y AGREGARÍA QUE…” Esta técnica explica cómo se puede estar de acuerdo con todo pero a la vez seguir manteniendo la opinión personal. Saber establecer un marco de acuerdos, transforma a la persona no solo en un bue",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 15",
        "realExample": "ue dejan el éxito financiero en las acciones de sus empleados o los que toman las riendas por sí mismos y construyen su propia empresa. ¿Qué clase de persona eres tú? ● En general, se puede decir que hay dos tipos de personas: las que emiten sus juicios antes de intentar algo y las que lo intentan y luego basan sus opiniones en las experiencias vividas. ¿Qué clase de persona eres tú? ● En general, se puede decir que hay dos tipos de personas: las que no aceptan los cambios pensando que todo tiempo pasado fue mejor y las que se adaptan a los tiempos que corren, creando un futuro mejor. ¿Qué clase de persona eres tú? Una variante de esta técnica es el “efecto señuelo”. En ella se describe la situación dando tres opciones de las cuales dos son legítimas y la tercera, que es semi-legítima, es un señuelo. Por ejemplo, dan tres opciones de suscripción a una web. En la primera el valor es 59 dólares al año. En la segunda, es de 125 al año (versión impresa) y la tercera es la suscripción impresa y web por 125 dólares al año. La segunda opción es un señuelo porque por el mismo precio se obtiene la opción 3 que incluye la versión web y versión impresa. Como puedes ver, según como presentes las opciones tendrás el éxito que buscas.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 2",
        "realExample": "en caso de ser descubierta. Incluso si se trata de una situación legal, queda impune porque puede alegar que la persona que preguntó no fue lo suficientemente específica con respecto a los detalles que tenía que dar. El ejemplo más claro de este tipo de mentiras es cuando un vendedor habla sobre un producto destacando sus bondades pero ocultando los aspectos negativos de su uso. Otro ejemplo sería cuando una persona hace tres comentarios sobre ti, uno es una crítica y los otros dos hablan en tu favor. Alguien te lo cuenta y si esta persona es ecuánime te hablará sobre los tres comentarios, pero si es un manipulador y está la opción de que saque ventaja de este comentario, seguramente, te contará la crítica omitiendo los dos comentarios ventajosos. No corregir los errores de concepto de otras personas cuando se las escucha hablar también es una mentira por omisión. Con este tipo de mentiras se puede llevar las suposiciones ajenas a un punto de conveniencia. Un manipulador con habilidad sabrá utilizar este recurso. Por ejemplo, una persona vestida como policía parada afuera de un banco, el que lo ve asume sin preguntar que es la custodia, aunque este haya ido al banco por un motivo personal. El contexto que ve la persona que observa hace que su mente llegue a una conclusión que parece lógica aunque puede no ser cierta. Los manipuladores conocen este tipo de artimañas y, por supuesto, las usan a su favor. Otro aspecto que es utilizado por los manipuladores es la negación. La neg",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 6",
        "realExample": "ucho peor y, en la mayoría de los casos, la víctima comienza a pensar que el abusador tiene razón y que por suerte sabe contenerse para no tener mayores consecuencias. Otra forma de utilizar la minimización es a través de lo que se conoce como distorsión cognitiva. En estos casos, se distorsionan ciertas acciones o emociones para que parezcan poco importantes. Un ejemplo característico en este sentido es: cuando una persona insulta a otra y, al producirse la confrontación por parte de la persona agredida, el agresor le dice que fue una broma insignificante que debería tener sentido del humor. Esta utilización de la minimización se encuentra en todos los órdenes de la vida, tanto personal como profesional, además de ser utilizada por las instituciones. Es necesario tener cuidado con las personas que minimizan a los demás porque suelen ocasionar mucho daño. EL REFLEJO Hay quienes tienen la habilidad de entender cada uno de los sentimientos o actitudes de los demás. Como si pudieran leer como un libro lo que la otra persona está viviendo. Esta habilidad determina que quien la posee pueda actuar como un camaleón y transformarse en el otro. Este se verá reflejado en él como si se viera en un espejo. Este reflejo abarcará los gustos, las preferencias, las situaciones actuales y pasadas. Tendrán coincidencia en todos los niveles de la existencia. Las personas que aprenden a ser lectoras de personalidad siguen una técnica que se divide en tres niveles. En estos tres niveles se recole",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 19",
        "realExample": "ima tendrá temor de perder esa relación y quedarse totalmente sola.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    ...
    "keyPillars": [
      ...
      {
        "title": "Parte 7",
        "realExample": "ítico estuviera activo, la persona podría dar el verdadero valor que tiene el comentario realizado por aquel que intenta manipularla. Notar estas sutilezas es el primer paso para liberarse de un manipulador. Es importante darse cuenta de lo que uno está sintiendo para hacer un análisis y así poder identificar cuál es el proceso interno que desencadenó ese sentimiento. Otra forma de identificar si alguien está tratando de manipularte es prestar atención a las conversaciones que se tienen. Si una persona está todo el tiempo remarcando tus errores, tanto en forma directa como sutil, es casi seguro que busca manipularte. Una vez identificado el manipulador es necesario alejarse de él. Si no es posible alejarse porque pertenece al entorno más cercano, es necesario poner en práctica el hecho de hacer caso omiso a todo lo que diga. Otra forma de gestionar los comentarios que generan culpa es explicándole a la persona que realiza los comentarios que ya has elaborado internamente tus conflictos y que lo que está expresando ya no te afecta a nivel emocional. Por tanto, que no siga gastando energía porque no va a conseguir que te sientas mal. INTIMIDACIÓN La intimidación es una acción que se ejerce sobre otra persona para doblegar su voluntad a partir del miedo. Se lleva a cabo de manera directa o indirecta a través de un trabajo sutil pero muy efectivo. El ejemplo más característico es cuando un asaltante dice que le entreguen el dinero mientras apunta con un arma a la víctima. La fina",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 12",
        "realExample": "ará los detalles que no le conviene revelar. Esta variación de manipulación, narración estratégica, es muy usada por los políticos. Sus discursos están plagados de hechos contados de esta manera y de detalles que se omiten deliberadamente. Por último, otra manera de manipular los hechos es exagerar determinadas partes del relato haciéndolo sensacionalista o quitando importancia al punto de minimizarlas. Esta técnica es utilizada por la publicidad, por las agencias de marketing, en las relaciones públicas y en algunos medios de comunicación. Es frecuente que los medios acentúen algunos rasgos de la información que están brindando mientras ocultan otros. Se puede apreciar esto principalmente en los titulares que colocan con la intención de dar un pantallazo de la información que desarrollan en el artículo. A nivel internacional, se ha utilizado esta técnica para desprestigiar naciones, introducir creencias, cambiar comportamientos. Fue muy utilizada en la guerra fría, se la conoció, también, como guerra psicológica. En todos los casos, nunca será un relato objetivo, no utilizará la mentira pero será una verdad a medias contada desde una perspectiva subjetiva.",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
  ...
  },
  {
    "id": "m11",
    "bookNumber": 11,
    "title": "Como Detectar Manipulacion Y Conclusion",
    "keyPillars": [
      {
        "title": "Parte 1",
        "realExample": "¿CÓMO DARSE CUENTA DE QUE SE ESTÁ SIENDO MANIPULADO? En general, el que ejerce la manipulación suele ser una persona encantadora, carismática y es difícil reconocer que sus acciones son malintencionadas porque en apariencia parece muy sincero y honesto. Su trabajo es sutil, elaborado, muy bien planeado y no se reconoce su accionar hasta que ha pasado un tiempo y se analizan los hechos. Es frecuente que al llenar los vacíos emocionales se cierren los aspectos racionales de la persona manipulada y esta no vea lo que está sucediendo en realidad. La gran habilidad que demuestra el manipulador hace que la víctima sea su títere manejado a su antojo. Por estas razones, es importante estar atento y aprender a visualizar las señales que distinguen a un manipulador. No es necesario conocer de técnicas para darse cuenta si alguien de tu entorno o un extraño está tratando de manipularte. Si estás en una relación es necesario analizar los siguientes puntos, en los que te mirarás a ti mismo, para saber si la otra persona ejerce la manipulación contigo: ● Cuando pasas de la alegría de haber encontrado finalmente el amor pero en poco tiempo esa alegría se transforma en temor a perderlo. Tus sentimientos de alegría y felicidad de pronto son sentimientos de tristeza, angustia y desesperación. ● Tus emociones no tienen término medio, pasas de un estado de plenitud a un estado de vacío sin mediar situaciones conflictivas. ● Mantienes la relación aún cuando la mayoría del tiempo no te encuentras",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
      ...
      {
        "title": "Parte 10",
        "realExample": "paración necesaria para no volver a caer en las redes de este tipo de individuos. Por último, recuperar los ideales y trabajar por el logro de un propósito de vida encaminará, finalmente, a la víctima. Si tienes el control de tu mente, sabes cómo piensas y cómo reaccionas es muy difícil que alguien pueda manipularte. Además, podrás detectar a este tipo de individuos y advertir a los desprevenidos que estén en tu entorno evitando, de esta manera, que sean manipulados. Cuando hay comunicación verdadera, cuando hay principios altruistas que guían naciones o grupos humanos se logra el verdadero florecimiento de la humanidad. Sabiendo lo mucho que puede influir un pensamiento en otras personas es hora de tomar la decisión de utilizarlo para lograr el bien común y relaciones personales sanas y fructíferas. Por último, quisiera decirte que me ayudan mucho las calificaciones en Amazon. Si encontraste placentera la lectura de este libro, califícalo y escribe tu opinión sincera acerca de él en Amazon aquí. Los comentarios me ayudan a mejorar y las buenas calificaciones contribuyen a incrementar las ventas del libro, algo que me permite dedicarle un poco más de tiempo a la escritura. ¡Gracias, espero que lo hayas disfrutado! - Giovani Barone. [1] La manipulación del hombre a través del lenguaje - Alfonso López Quintás [2] Cómo Influir en las Personas - Yoritomo - Tashi [3] Manipulación - H. G. Tudor",
        "interactiveChallenge": {
          "question": "¿Cuál es la lección principal de esta lectura?",
          "options": [
            {
